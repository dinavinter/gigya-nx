...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/accounts/Gigya.Js.Plugin.Pages/app/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var GoogleAnalytics_1 = __webpack_require__(/*! src/core/Gigya.Js/app/GoogleAnalytics/GoogleAnalytics */ "./src/core/Gigya.Js/app/GoogleAnalytics/GoogleAnalytics.ts");
var consts_1 = __webpack_require__(/*! ./types/consts */ "./src/accounts/Gigya.Js.Plugin.Pages/app/types/consts.ts");
var HostedPageAnalytics_1 = __webpack_require__(/*! ./utils/Analytics/HostedPageAnalytics */ "./src/accounts/Gigya.Js.Plugin.Pages/app/utils/Analytics/HostedPageAnalytics.ts");
...
var PagesPlugin = /** @class */ (function (_super) {
    ...
    PagesPlugin.prototype.init = function (callback) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                googleAnalyticsConfig = ((_a = this.params) !== null && _a !== void 0 ? _a : {}).googleAnalyticsConfig;
                if ((googleAnalyticsConfig === null || googleAnalyticsConfig === void 0 ? void 0 : googleAnalyticsConfig.isActive) === 'true') {
    ...
    PagesPlugin.getPageImplementation = function (type) {
        ...
        return PagesPlugin.PageLibrary[type] || PagesPlugin.PageLibrary[consts_1.PageType.Generic];
    };
    PagesPlugin.getLoginType = function () {
        var urlParams = window.gigya.utils.URL.getParamsFromURL(document.location.href);
    ...
    PagesPlugin.prototype.initGAnalytics = function (googleAnalyticsConfig) {
        var pageAnalyticsConfig = new HostedPageAnalytics_1.HostedPageAnalytics(googleAnalyticsConfig, window.gigya);
        new GoogleAnalytics_1.GoogleAnalytics(googleAnalyticsConfig, [pageAnalyticsConfig]).start();
    };
...
var PagesPlugin_1 = __webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/PagesPlugin */ "./src/accounts/Gigya.Js.Plugin.Pages/app/PagesPlugin.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/GenericPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/GenericPage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/SiteLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/SiteLoginPage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/SSOLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/SSOLoginPage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/SAMLLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/SAMLLoginPage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/OIDCLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/OIDCLoginPage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/ProfileUpdatePage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/ProfileUpdatePage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/ResetPasswordPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/ResetPasswordPage.ts");
__webpack_require__(/*! src/accounts/Gigya.Js.Plugin.Pages/app/pages/DeviceRegistrationPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/DeviceRegistrationPage.ts");
if (!window.gigya._) {
    window.gigya._ = {};
}
...
var PagesPlugin_2 = __webpack_require__(/*! ./PagesPlugin */ "./src/accounts/Gigya.Js.Plugin.Pages/app/PagesPlugin.ts");
exports.IPagesParams = PagesPlugin_2.IPagesParams;
exports.IPage = PagesPlugin_2.IPage;
var consts_1 = __webpack_require__(/*! ./types/consts */ "./src/accounts/Gigya.Js.Plugin.Pages/app/types/consts.ts");
exports.PageType = consts_1.PageType;
var pages_1 = __webpack_require__(/*! ./pages */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/index.ts");
...
exports.pages = function () { return window.gigya._.plugins.Pages; };
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var temlates_1 = __webpack_require__(/*! ../types/temlates */ "./src/accounts/Gigya.Js.Plugin.Pages/app/types/temlates.ts");
var GSErrors = window.gigya.GSErrors;
var domain_1 = __webpack_require__(/*! ../utils/domain */ "./src/accounts/Gigya.Js.Plugin.Pages/app/utils/domain.ts");
var Flow_1 = __webpack_require__(/*! src/core/Gigya.Js/app/Flow/Flow */ "./src/core/Gigya.Js/app/Flow/Flow.ts");
var object_1 = __webpack_require__(/*! src/core/Gigya.Js/app/Utils/object */ "./src/core/Gigya.Js/app/Utils/object.ts");
var BasePage = /** @class */ (function () {
    ...
    BasePage.prototype.showPageScreenSet = function (params, callback) {
        var _this = this;
        var _a = this.params, startScreen = _a.startScreen, screenSet = _a.screenSet;
        this.addHostedPagesEventsListeners();
        var showScreenSetParams = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ startScreen: startScreen,
            screenSet: screenSet }, this.getBasicScreenSetParams()), params), { callback: function (res) {
                if (res.errorCode !== GSErrors.OK) {
                    _this.showError(res.errorMessage);
                }
                callback(res.errorCode === 0);
            } });
        window.gigya.accounts.showScreenSet(tslib_1.__assign({}, showScreenSetParams));
    };
    BasePage.prototype.getBasicScreenSetParams = function () {
        var _a;
        var paramsFromURL = window.gigya.utils.URL.getParamsFromURL(window.location.href);
        return object_1.removeUndefined({
            containerID: (_a = this.params) === null || _a === void 0 ? void 0 : _a.containerID,
    ...
    BasePage.prototype.showError = function (message) {
        if (this.params.errorUri) {
            ...
            var _a = this.params, screenSet = _a.screenSet, containerID = _a.containerID;
            var container = document.querySelector("#" + containerID);
            if (container) {
                window.gigya.accounts.hideScreenSet({ screenSet: screenSet, containerID: containerID });
                container.innerHTML = window.gigya.utils.templates.fill(temlates_1.errorMessageTemplate, { message: message });
            }
        }
    };
    ...
    BasePage.prototype.onAfterLogin = function (event) {
        var _a, _b, _c;
        if ((_c = (_b = (_a = this.params) === null || _a === void 0 ? void 0 : _a.identityFlowsConfig) === null || _b === void 0 ? void 0 : _b.selectedFlow) === null || _c === void 0 ? void 0 : _c.id) {
            ...
            var flow = new Flow_1.Flow(flowId, { screenSetParams: screenSetParams }, loginHandler);
            flow.execute();
        }
        else {
            this.onLogin(event);
    ...
    BasePage.prototype.onAfterSubmit = function (event) {
        var _a;
        if (((_a = event === null || event === void 0 ? void 0 : event.response) === null || _a === void 0 ? void 0 : _a.errorCode) === GSErrors.OK) {
    ...
    BasePage.prototype.addHostedPagesEventsListeners = function () {
        ...
        (_a = window.gigya.defaultEventMaps) === null || _a === void 0 ? void 0 : _a.push(config);
        window.gigya.accounts.addEventHandlers({
            onLogin: function (e) { return _this.onAfterLogin(e); },
            onLogout: function (e) { return _this.onLogout(e); }
        });
    };
    return BasePage;
}());
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var PagesPlugin_1 = __webpack_require__(/*! ../PagesPlugin */ "./src/accounts/Gigya.Js.Plugin.Pages/app/PagesPlugin.ts");
var consts_1 = __webpack_require__(/*! ../types/consts */ "./src/accounts/Gigya.Js.Plugin.Pages/app/types/consts.ts");
var RequireSessionPage_1 = __webpack_require__(/*! ./RequireSessionPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/RequireSessionPage.ts");
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.PageType.DeviceRegistration, DeviceRegistrationPage);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var BasePage_1 = __webpack_require__(/*! ./BasePage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/BasePage.ts");
var PagesPlugin_1 = __webpack_require__(/*! ../PagesPlugin */ "./src/accounts/Gigya.Js.Plugin.Pages/app/PagesPlugin.ts");
var consts_1 = __webpack_require__(/*! ../types/consts */ "./src/accounts/Gigya.Js.Plugin.Pages/app/types/consts.ts");
var GenericPage = /** @class */ (function (_super) {
    ...
    GenericPage.prototype.redirectToLoginPage = function (withReturnUrl) {
        if (withReturnUrl === void 0) { withReturnUrl = false; }
        if (this.params.loginUri) {
            var url = this.params.loginUri + (withReturnUrl ? "?redirectURI=" + encodeURIComponent(this.currentLocation) : '');
            this.redirect(url);
        }
        else {
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.PageType.Generic, GenericPage);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = mode;
                        switch (_a) {
                            case "forceLogin": return [3 /*break*/, 1];
                            case "login": return [3 /*break*/, 3];
                            case "passiveLogin": return [3 /*break*/, 3];
                            case "afterConsent": return [3 /*break*/, 4];
                            case "error": return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 6];
                    case 1: return [4 /*yield*/, window.gigya._.apiAdapters.web.tokenStore.remove()];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.LoginType.OIDC, OIDCLoginPage);
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.PageType.ProfileUpdate, ProfileUpdatePage);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var GenericPage_1 = __webpack_require__(/*! ./GenericPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/GenericPage.ts");
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.PageType.ResetPassword, ResetPasswordPage);
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case 'passiveLogin': return [3 /*break*/, 1];
                            case 'afterLogin': return [3 /*break*/, 2];
                            case 'forceLogin': return [3 /*break*/, 3];
                    ...
                    case 2:
                        this.samlContinue();
                        return [3 /*break*/, 7];
                    case 3: return [4 /*yield*/, window.gigya._.apiAdapters.web.tokenStore.remove()];
                    case 4:
                        _b.sent();
                        this.showPageScreenSet({}, callback);
                        return [3 /*break*/, 7];
                    case 5:
                        cancelParams = {
                            cancelCode: window.gigya.getUrlParam('cancelCode') || null,
                            statusCode: window.gigya.getUrlParam('statusCode') || null,
                        };
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.LoginType.SAML, SAMLLoginPage);
    ...
    SSOLoginPage.prototype.start = function (callback) {
        ...
        window.gigya.hasSession().then(function (sessionExist) {
            if (sessionExist) {
                ...
                var gigParams = window.gigya.utils.URL.getGigParamsFromURL({ url: document.location.href, removePrefix: true });
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.LoginType.SSO, SSOLoginPage);
...
PagesPlugin_1.PagesPlugin.addPageToLibrary(consts_1.LoginType.SiteLogin, SiteLoginPage);
...
var DeviceRegistrationPage_1 = __webpack_require__(/*! ./DeviceRegistrationPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/DeviceRegistrationPage.ts");
exports.DeviceRegistrationPage = DeviceRegistrationPage_1.DeviceRegistrationPage;
var OIDCLoginPage_1 = __webpack_require__(/*! ./OIDCLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/OIDCLoginPage.ts");
exports.OIDCLoginPage = OIDCLoginPage_1.OIDCLoginPage;
var SAMLLoginPage_1 = __webpack_require__(/*! ./SAMLLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/SAMLLoginPage.ts");
exports.SAMLLoginPage = SAMLLoginPage_1.SAMLLoginPage;
var SiteLoginPage_1 = __webpack_require__(/*! ./SiteLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/SiteLoginPage.ts");
exports.SiteLoginPage = SiteLoginPage_1.SiteLoginPage;
var SSOLoginPage_1 = __webpack_require__(/*! ./SSOLoginPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/SSOLoginPage.ts");
exports.SSOLoginPage = SSOLoginPage_1.SSOLoginPage;
var ProfileUpdatePage_1 = __webpack_require__(/*! ./ProfileUpdatePage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/ProfileUpdatePage.ts");
exports.ProfileUpdatePage = ProfileUpdatePage_1.ProfileUpdatePage;
var ResetPasswordPage_1 = __webpack_require__(/*! ./ResetPasswordPage */ "./src/accounts/Gigya.Js.Plugin.Pages/app/pages/ResetPasswordPage.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
var HostedPageAnalyticsEvents_1 = __webpack_require__(/*! ./HostedPageAnalyticsEvents */ "./src/accounts/Gigya.Js.Plugin.Pages/app/utils/Analytics/HostedPageAnalyticsEvents.ts");
var HostedPageAnalytics = /** @class */ (function () {
    ...
    HostedPageAnalytics.prototype.register = function (sendAnalytics) {
        ...
        var hostedPageAnalyticsConfig = {
            ...
            defaultMethod: function (event) {
                var _a;
                var eventName = (_a = event === null || event === void 0 ? void 0 : event.fullEventName) !== null && _a !== void 0 ? _a : event === null || event === void 0 ? void 0 : event.eventName;
                var eventTitle = HostedPageAnalyticsEvents_1.GigyaEventTitleMap.get(eventName);
                var eventHandler = HostedPageAnalyticsEvents_1.GigyaEventHandlersMap.get(eventName);
                if (!eventHandler) {
                    return;
                }
            ...
            eventMap: [
                {
                    events: (_a = this.config) === null || _a === void 0 ? void 0 : _a.events,
                    args: [function (e) { return e; }]
                }
            ]
        };
        (_b = this.events.defaultEventMaps) === null || _b === void 0 ? void 0 : _b.push(hostedPageAnalyticsConfig);
    };
    ;
...
var afterSubmitEventHandler = function (event) {
    ...
    var _b = (_a = event === null || event === void 0 ? void 0 : event.response) !== null && _a !== void 0 ? _a : {}, errorCode = _b.errorCode, errorDetails = _b.errorDetails, errorMessage = _b.errorMessage, operation = _b.operation;
    return tslib_1.__assign(tslib_1.__assign({}, basicPayload), { errorCode: errorCode,
...
function isTrustedDomain(url, hostedPagesDomain) {
    if (hostedPagesDomain === void 0) { hostedPagesDomain = window.gigya._.config.hostedPagesDomain; }
    var domain = url.match(/^(?:https?:\/\/)(?:www\.)?([^:\/?]+)/);
    if (domain && domain[1]) {
        var baseDomains = window.gigya._.config.api.baseDomains;
        baseDomains = baseDomains.map(function (d) { return d.replace('*', ''); });
        baseDomains.push(hostedPagesDomain);
        return baseDomains.filter(function (d) { return window.gigya.utils.stringUtils.endsWith(domain[1], d); }).length > 0;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var interfaces_1 = __webpack_require__(/*! ./interfaces */ "./src/core/Gigya.Js/app/Flow/interfaces.ts");
var queue_1 = __webpack_require__(/*! ../Utils/queue */ "./src/core/Gigya.Js/app/Utils/queue.ts");
var InitActivity_1 = __webpack_require__(/*! ./activities/InitActivity */ "./src/core/Gigya.Js/app/Flow/activities/InitActivity.ts");
var ActivityLibrary_1 = __webpack_require__(/*! ./activities/ActivityLibrary */ "./src/core/Gigya.Js/app/Flow/activities/ActivityLibrary.ts");
var ScreenSetActivity_1 = __webpack_require__(/*! ./activities/ScreenSetActivity */ "./src/core/Gigya.Js/app/Flow/activities/ScreenSetActivity.ts");
var EventActivity_1 = __webpack_require__(/*! ./activities/EventActivity */ "./src/core/Gigya.Js/app/Flow/activities/EventActivity.ts");
var Flow = /** @class */ (function () {
    ...
    Flow.prototype.execute = function () {
        ...
        if (ActivityLibrary_1.ActivityLibrary.isEmpty()) {
            ActivityLibrary_1.ActivityLibrary.registerActivity(interfaces_1.ActivityType.ScreenSet, ScreenSetActivity_1.ScreenSetActivity);
            ActivityLibrary_1.ActivityLibrary.registerActivity(interfaces_1.ActivityType.Event, EventActivity_1.EventActivity);
        }
...
var ActivityLibrary = /** @class */ (function () {
    ...
    ActivityLibrary.getActivity = function (flow, params) {
        if (this.activityMap.has(params === null || params === void 0 ? void 0 : params.activityType)) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var tokenStore = __webpack_require__(/*! ../../../../Gigya.Js.Adapters.Web/app/TokenStore */ "./src/core/Gigya.Js.Adapters.Web/app/TokenStore.ts");
var RequestProvider_1 = __webpack_require__(/*! src/core/ApiService/app/RequestProvider */ "./src/core/ApiService/app/RequestProvider.ts");
var ActivityLibrary_1 = __webpack_require__(/*! ./ActivityLibrary */ "./src/core/Gigya.Js/app/Flow/activities/ActivityLibrary.ts");
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!result) {
                            ...
                            activity = ActivityLibrary_1.ActivityLibrary.getActivity(this.flow, result);
    ...
    BaseActivity.prototype.fetch = function (url) {
        return tslib_1.__awaiter(this, void 0, gigya.Promise, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        baseDomain = "https://" + window.gigya._.getApiDomain('accounts');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._requestProvider.send(baseDomain, "workflow" + url, this.getRequestParams(), {}, {})];
                    case 2: return [2 /*return*/, _a.sent()];
                    case 3:
                        e_1 = _a.sent();
                        window.gigya.logger.report('Flow request fail', { url: url, e: e_1 });
                        return [2 /*return*/, null];
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(/*! tslib */ "../node_modules/tslib/tslib.es6.js");
var BaseActivity_1 = __webpack_require__(/*! ./BaseActivity */ "./src/core/Gigya.Js/app/Flow/activities/BaseActivity.ts");
var interfaces_1 = __webpack_require__(/*! ../interfaces */ "./src/core/Gigya.Js/app/Flow/interfaces.ts");
var ActivityLibrary_1 = __webpack_require__(/*! ./ActivityLibrary */ "./src/core/Gigya.Js/app/Flow/activities/ActivityLibrary.ts");
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.params.afterEventUrl && this.next(this.params.afterEventUrl);
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
...
ActivityLibrary_1.ActivityLibrary.registerActivity(interfaces_1.ActivityType.Event, EventActivity);
...
var InitActivity = /** @class */ (function (_super) {
    ...
    InitActivity.prototype.run = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.next("/runtime/v1/workflowDefinitions/" + this.flow.identityFlowId + "/dispatch")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ScreenSetActivity.prototype.run = function () {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                ...
                window.gigya.accounts.showScreenSet(tslib_1.__assign(tslib_1.__assign({}, (_a = this.flow.flowParams) === null || _a === void 0 ? void 0 : _a.screenSetParams), { screenSet: this.params.screenSet, startScreen: this.params.startScreen, onAfterSubmit: function (event) {
                        var _a;
                        if (((_a = event.response) === null || _a === void 0 ? void 0 : _a.errorCode) === GSErrors_1.GSErrors.OK) {
                            _this.params.onSubmitUrl && _this.next(_this.params.onSubmitUrl);
                        }
                        else {
...
ActivityLibrary_1.ActivityLibrary.registerActivity(interfaces_1.ActivityType.ScreenSet, ScreenSetActivity);
...
var GoogleAnalytics = /** @class */ (function () {
    ...
    GoogleAnalytics.prototype.start = function () {
        var _this = this;
        var _a;
        if (!((_a = this.config) === null || _a === void 0 ? void 0 : _a.googleAnalyticsGTag) || !this.analytics) {
            return;
        }
        var globalScript = this.createGAGlobalScript(this.config.googleAnalyticsGTag);
    ...
    GoogleAnalytics.prototype.createGAGlobalScript = function (trackingId) {
    ...
    GoogleAnalytics.prototype.addMandatoryGAConfig = function (trackingId) {
        this.gtag('js', new Date());
        this.gtag('config', "" + trackingId);
    };
    GoogleAnalytics.prototype.sendAnalytics = function (command, commandParameters, payload) {
