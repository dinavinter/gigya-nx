...
(function () {
    ...
    if ((typeof _pi.login == 'undefined') || (typeof _pi.login.showLoginUI_v1 == 'undefined')) {
        ...
        _pi.login.showUI = function (c, p, internals) {
            ...
            resolver.addConfig('<config><body font="arial"><captions bold="true" size="16" color="#4c4c4c" /><controls size="11"><snbuttons type="" buttonsize="30" color="#9b9b9b" /></controls><background background-color="transparent" /><texts size="11"><links color="#1371b9" /></texts></body></config>');
            ...
            if (!showWelcome) {
                ...
                if (pages > 1) {
                    arHTML[a++] = '<div align="left" style="margin-left: auto;width:' + (arrowW + bhs) + 'px; text-align: left"><div style="text-align:right;width: ' + (arrowW) + 'px;"><img tabindex="0" aria-label="previous" title="previous" alt="previous" onkeydown="' + gsLogin + '.KeyDownHandler(event,this)" alt="" onclick="' + gsLogin + '.prevPage(\'' + containerID + '\')" style="cursor:pointer;display:none;width:' + (arrowW) + 'px;" id="' + containerID + '_arrow_left" src="' + scrollingLeftPath + '" /><img title="previous button disabled" alt="previous button disabled" style="display:none;width:' + (arrowW) + 'px;" id="' + containerID + '_arrow_left_disable" src="' + scrollingLeftDisablePath + '" /></div></div>';
                }
                arHTML[a++] = '</div></td>';
            ...
            if (showWelcome) {
                ...
                arHTML[a++] = '<tr><td height="' + welcomeBtnSize + '" style="' + tdStyle + 'padding-bottom:15px;"><span tabindex="0" role="button" style="cursor:pointer" onkeydown="' + gsLogin + '.KeyDownHandler(event,this)" onclick="' + gsLogin + '.providerClick(\'' + containerID + '\',\'' + lastLoginProvider + '\')"><img gigid="' + provider + '" alt="" height="' + welcomeBtnSize + '" src="' + btnSrc + '"  /></span></td></tr>';
                    ...
                    for (var iCol = 0; iCol < maxButtonsInCol; iCol++) {
                        ...
                        for (var iRow = 0; iRow < maxButtonsInRow; iRow++) {
                            ...
                            if (provider != null) {
                                ...
                                var ariaLabel = provider.context.connected ? `${provider.displayName} Connected`: provider.displayName;
                                ...
                                var imgHTML = spriteRenderer.loginIcons.getHTML(imgId, false, oStyle.dontUseSprites,'',title,undefined,title,ariaLabel);
                                ...
                                if (disabled) {
                                    ...
                                    arHTML[a++] = '<td style="' + tdStyle + snButtonsStyle + paddingRules + 'text-align:center;vertical-align:top"><center><div onkeydown="' + gsLogin + '.KeyDownHandler(event,this)"  onclick="' + gsLogin + '.providerClick(\'' + containerID + '\',\'' + provider.name + '\')" title="' + title + '" alt="' + title + '" style="zoom:1;cursor:pointer; width:' + btnW + 'px;"><div gigid="' + provider + '" style="width:' + btnImgW + 'px; height:' + btnImgH + 'px">' + imgHTML + '</div>';
                                }
            ...
            if (!showWelcome) {
                ...
                if (pages > 1 && !showWelcome) {
                    arHTML[a++] = '<div style="' + tdStyle + 'text-align:right; width:' + (arrowW + bhs) + 'px;"><img tabindex="0" aria-label="next" title="next" alt="next" onkeydown="' + gsLogin + '.KeyDownHandler(event,this)"  onclick="' + gsLogin + '.nextPage(\'' + containerID + '\')" style="cursor:pointer;display:none;width:' + (arrowW) + 'px;" id="' + containerID + '_arrow_right" src="' + scrollingRightPath + '" /><img title="next button disabled" alt="next button disabled" style="display:none;width:' + (arrowW) + 'px;" id="' + containerID + '_arrow_right_disable" src="' + scrollingRightDisablePath + '" /></div>';
                }
                arHTML[a++] = '</td>';
            } else {
                arHTML[a++] = '<td></td>';
            ...
            if (showEdit) {
                ...
                leftBottomLinkHTML += '<span tabindex="0" style="' + linkStyle + ';padding-right:5px;padding-left:5px;text-decoration:none;font-size:11px" onkeydown="' + gsLogin + '.KeyDownHandler(event,this)" onclick="' + gsLogin + '.showEdit(\'' + containerID + '\')">' + this.TEXT(lang, 'edit') + '</span>';
            }
            var rightBottomLinkHTML = '';  
            if (showGigyaBranding) {
                rightBottomLinkHTML += '<a target="_blank" tabindex="0" href="http://www.gigya.com/"  style="color:#005997;font-weight:bold; font-size:11px;cursor:pointer" onfocusin="' + gsLogin + '.showWhatsThis(\'' + containerID + '\')" onfocusout="' + gsLogin + '.hideWhatsThis(\'' + containerID + '\')" onMouseOut="' + gsLogin + '.hideWhatsThis(\'' + containerID + '\')" onMouseOver="' + gsLogin + '.showWhatsThis(\'' + containerID + '\')"><span style="color:#6E6E6E;font-weight:bold; font-size:11px;cursor:pointer">Social by </span>Gigya</a>';
