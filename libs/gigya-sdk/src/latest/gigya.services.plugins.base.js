...
/***/ (function(module, exports, __webpack_require__) {
        ...
        var result = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js!./defaultCSS.css */ "../node_modules/css-loader/dist/cjs.js!./src/accounts/Gigya.JS.Plugin.screenSet2/app/style/defaultCSS.css");
...
var BasePlugin = /** @class */ (function (_super) {
        ...
        if (this.container) {
            if (this.isModal) {
                ...
                if (this.config.enableSizePolling && (!this.params.width || this.params.width.toString().indexOf('%', this.params.width.length - 1) !== -1)) {
                    ...
                    if (FlagService_1.FlagService.useViewportPollerAction && this.config.enableViewportPolling) {
                        this._poller.addActions(new PollerActions_1.ViewportSizeAction(function (old, curr) {
                            _this.onViewportSizeChanged(old, curr);
                            _this.refreshExternalComponents();
                        }));
    ...
    BasePlugin.prototype.createModalDialog = function () {
        ...
        this.hotKeyEvent = window.gigya.utils.keyboard.onHotKeyClicked(hotKeyData, function () {
            _this.close();
        });
    };
    ...
    BasePlugin.prototype.getText = function (key, replaceStr, withStr) {
        var text;
        var customLang = tslib_1.__assign({}, window.gigya.utils.object.normalizeObjectKeysToLowerCase(this.params.customLang || {}));
        ...
        return text === null || text === void 0 ? void 0 : text.replace(replaceStr, withStr);
    };
    BasePlugin.prototype.toString = function () {
        return this.params.containerID ? this.params.containerID + '.' + this.injectionInfo.name : this.injectionInfo.name;
    };
...
function placePopoverNearElement(elTarget, container, direction, margin, flip, adjustDirection) {
    ...
    var position = getRelativePosition(targetPosition, size, direction, margin, flip);
    if (adjustDirection && !window.gigya.utils.viewport.isRectFullyVisible(position)) {
        ...
        var newPosition = getRelativePosition(targetPosition, size, opposite[direction], margin, false);
    ...
    if (!window.gigya.utils.viewport.isRectHorizontallyVisible(position)) {
        var newPosition = getRelativePosition(targetPosition, size, direction, margin, !flip);
        if (window.gigya.utils.viewport.isRectHorizontallyVisible(newPosition))
            position = newPosition;
    }
...
function addPopoverNearElement(elTarget, elPopover, direction, margin, flip, adjustDirection, animation, fnWhenRemoved, removeOnClickExlcludedElements) {
    ...
    placePopoverNearElement(elTarget, container, direction, margin, flip, adjustDirection);
...
SpriteRenderer.prototype = {
    ...
    getHTML: function (spriteId, autoMargin, dontUseSprites, elID, altText, tabindex, title, ariaLabel) {
        if (elID === void 0) { elID = ''; }
        ...
        arHTML.push("<button aria-label=\"" + aria + "\" " + (title ? "title=\"" + title + "\"" : '') + " alt=\"" + altText + "\" type=\"button\" class=\"tabbing-button\" " + tabindexAttr + " style=\"height:" + this.spriteH + "px;\">");
        if (oSprite) {
...
function getLocalizedText(plugin, textKey, lang, replaceStr, withStr) {
    ...
    var fallbackTranslation = (_c = (_b = (_a = window.gigya.i18n) === null || _a === void 0 ? void 0 : _a[screensetPlugin]) === null || _b === void 0 ? void 0 : _b[lang]) === null || _c === void 0 ? void 0 : _c[textKey];
...
function getTranslationsFromContainer(container, lang, fallbackEnabled, defaultTranslationsLang) {
    ...
    if (!container || !container.translations)
        return undefined;
    var langKeys = (lang === null || lang === void 0 ? void 0 : lang.split(',').map(function (k) { return k.trim(); })) || [];
    for (var _i = 0, langKeys_1 = langKeys; _i < langKeys_1.length; _i++) {
        ...
        if (fallbackLang_1) {
            var translation = getTranslationsFromContainer(container, fallbackLang_1);
            if (fallbackEnabled && translation) {
                return translation;
            }
        }
    }
    var fallbackLang = getFallbackLang(langKeys[0], defaultTranslationsLang);
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        var result = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js!./legacy_modal.css */ "../node_modules/css-loader/dist/cjs.js!./src/core/Gigya.Js.Plugin/app/css/legacy_modal.css");
...
/***/ (function(module, exports, __webpack_require__) {
        ...
        var result = __webpack_require__(/*! !../../../../../../node_modules/css-loader/dist/cjs.js!./modern_modal.css */ "../node_modules/css-loader/dist/cjs.js!./src/core/Gigya.Js.Plugin/app/css/modern_modal.css");
...
var ModalDialog = /** @class */ (function (_super) {
    ...
    ModalDialog.prototype.create = function (hide) {
        ...
        (_a = this._captionContainer) === null || _a === void 0 ? void 0 : _a.removeAttribute('tabindex');
        // Adding modal events
...
var HotKeyEvent = /** @class */ (function () {
    function HotKeyEvent(hotKeyData, handler) {
        this.el = hotKeyData.elementContext ? hotKeyData.elementContext : document.body;
        this.eventHandler = function (event) {
            if (event.which === hotKeyData.key || event.key === exports.keyCodes[hotKeyData.key]) {
                handler();
            }
        };
