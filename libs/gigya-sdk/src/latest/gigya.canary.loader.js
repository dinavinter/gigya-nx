...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/core/Canary/app/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
var CookieProvider_1 = __webpack_require__(/*! ./CookieProvider */ "./src/core/Canary/app/CookieProvider.ts");
var Canary = /** @class */ (function () {
    function Canary(_config, _scriptUrl, _cookieProvider, _cookiesNames, _xhrFactory, _random) {
        if (_cookieProvider === void 0) { _cookieProvider = new CookieProvider_1.CookieProvider(); }
        if (_cookiesNames === void 0) { _cookiesNames = _config.cookiesNames; }
        if (_xhrFactory === void 0) { _xhrFactory = function () { return new XMLHttpRequest(); }; }
    ...
    Canary.prototype.shouldCanary = function () {
        ...
        if (this.wasCanarySet()) {
            return this._cookieProvider.get(this._cookiesNames.isCanary) == 'true';
        }
        else {
    ...
    Canary.prototype.rollCanary = function () {
        ...
        this._cookieProvider.put(this._cookiesNames.isCanary, isCanary.toString());
        this._cookieProvider.put(this._cookiesNames.version, this._config.version);
        return isCanary;
    };
    ...
    Canary.prototype.bootstrap = function (isOriginalScript) {
        if (isOriginalScript === void 0) { isOriginalScript = !window.gigya.canary.isActive; }
        if (!this._config.probability || (window.gigya.canary.isLoaded && !window.gigya.canary.isActive)) {
...
var GigyaCanary = __webpack_require__(/*! src/core/Canary/app/Canary */ "./src/core/Canary/app/Canary.ts");
var Canary_1 = __webpack_require__(/*! src/core/Canary/app/Canary */ "./src/core/Canary/app/Canary.ts");
__webpack_require__(/*! current-script-polyfill */ "../node_modules/current-script-polyfill/currentScript.js");
if (!window.gigya.canary) {
    window.gigya.canary = {};
}
__webpack_provided_Object_dot_assign(window.gigya.canary, GigyaCanary);
(function () {
    var _a;
    var script = document.currentScript;
    new Canary_1.Canary(window.gigya.canary.config, (_a = script === null || script === void 0 ? void 0 : script.src) !== null && _a !== void 0 ? _a : '')
        .bootstrap();
})();
