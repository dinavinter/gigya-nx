...
***************************************************************************** */
  ...
  \******************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.global = __webpack_require__(
          /*! ./css/global.css */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/css/global.css'
        );
  ...
  \*********************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var shouldRenderProvider = function (provider) {
          return provider !== 'site' && provider !== 'lite-email';
        };
        ...
        var EditConnectionPlugin = /** @class */ (function (_super) {
          ...
          function EditConnectionPlugin() {
            ...
            _this.onUserStateChange = function () {
              return _this.UserStateChanged();
            };
            return _this;
          }
          ...
          EditConnectionPlugin.prototype.init = function (loadedCallback) {
            var _this = this;
            this.showTooltips = window.gigya.utils.validation.isExplicitTrue(
            ...
            window.gigya.utils.array.forEach(
              this.params.customButtons || [this.params.customButton],
              function (oButton) {
                ...
                if (
                  ...
                  var pCustomProvider = window.gigya.utils.object.clone(
                    window.gigya.socialize._getProviderByID(4122)
                  );
          ...
          EditConnectionPlugin.prototype.initDimensions = function () {
            ...
            var fQuery = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-edit-connections-footer'
            );
            // if the footer found
            if (fQuery.length) {
              ...
              footerHeight = window.gigya.utils.DOM.getHTMLSize(
                footer.innerHTML,
                footer
              ).h;
            }
            // subtructing the footer size from the list of connections
            var connectionsListHeight =
              parseInt(this.params.height) - footerHeight;
            var heightCss =
              '.gig-edit-connections {' +
              [
                'height: ',
                connectionsListHeight,
                'px;',
                'min-width: 215px;',
              ].join('') +
              '}';
          ...
          EditConnectionPlugin.prototype.registerLocalEvents = function () {
            var _this = this;
            var connectLinkElements = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-edit-connections-connectLink'
            );
            var disconnectLinkElements =
              window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gig-edit-connections-disconnectLink'
              );
            var eventName =
          ...
          EditConnectionPlugin.prototype.unregisterToGlobalEvents =
            function () {
          ...
          EditConnectionPlugin.prototype.getControlHtml = function () {
            ...
            for (var _i = 0, _a = this.providers; _i < _a.length; _i++) {
              var provider = _a[_i];
              if (!shouldRenderProvider(provider.name)) continue;
              if (this.user.identities.hasOwnProperty(provider.name)) {
                connectedProviders.push(
                  this.getProviderListItem(
                    provider,
                    this.user.identities[provider.name]
                  )
                );
              } else {
                notConnectedProviders.push(
                  this.getProviderListItem(provider, null)
                );
              }
            }
            ...
            for (var p in this.user.identities) {
              if (!shouldRenderProvider(p)) continue;
              var found = false;
              for (var i = 0; i < this.providers.length; i++) {
                if (this.providers[i].name === p) found = true;
              }
              if (!found) {
                // not found, add to the list:
                var missingProvider =
                  window.gigya._.providers.getProviderByName(p);
                connectedProviders.push(
                  this.getProviderListItem(
                    missingProvider,
                    this.user.identities[p]
                  )
                );
              }
            }
            ...
            return window.gigya.utils.templates.fill(this.getTemplates().edit, {
              providersData:
                connectedProviders.join('') + notConnectedProviders.join(''),
              footer: this.getFooter(),
            });
          };
          // return a Provider li element, if the data exists, adding the identity data
          EditConnectionPlugin.prototype.getProviderListItem = function (
            provider,
            identityObject
          ) {
            ...
            if (identityObject) {
              ...
              if (this.providerAppsLinks.hasOwnProperty(provider.name)) {
                socialProviderApps = window.gigya.utils.templates.fill(
                  this.getTemplates().socialProviderApps,
                  {
              ...
              return window.gigya.utils.templates.fill(
                this.getTemplates().connectedSocialProvider,
                {
                  ...
                  ariaLabel:
                    ...
                    ' Connected. Username ' +
                    (identityObject === null || identityObject === void 0
                      ? void 0
                      : identityObject.nickname),
                }
              );
            } else {
              // -- > socialProviderNotConnected
              return window.gigya.utils.templates.fill(
                this.getTemplates().disconnectedSocialProvider,
                {
          ...
          EditConnectionPlugin.prototype.getPluginImage = function (
            provider,
            identity
          ) {
            if (provider.buttonData) {
              if (!identity) {
                ...
                return (
                  provider.buttonData.connectedIconURL ||
                  provider.buttonData.iconURL
                );
              }
            } else {
          ...
          EditConnectionPlugin.prototype.getIdentityCountry = function (
            identity
          ) {
            if (identity.country) {
              return window.gigya.utils.templates.fill(
                this.getTemplates().identityCountry,
                {
          ...
          EditConnectionPlugin.prototype.getIdentityCity = function (identity) {
            if (identity.city) {
              return window.gigya.utils.templates.fill(
                this.getTemplates().identityCity,
                {
          ...
          EditConnectionPlugin.prototype.getIdentityBirthDate = function (
            identity
          ) {
            if (
              identity.birthYear &&
              ...
              if (!day) day = '??';
              return window.gigya.utils.templates.fill(
                this.getTemplates().identityBirthDate,
                {
          ...
          EditConnectionPlugin.prototype.getIdentityPhotoUrl = function (
            identity
          ) {
            var url = identity.thumbnailURL;
            if (!url) url = identity.photoURL;
            if (!url)
              url = window.gigya.utils.templates.fill(
                this.getTemplates().defaultPhotoURL,
                {
          ...
          EditConnectionPlugin.prototype.getFooter = function () {
            ...
            if (showTerms) {
              var brand = '';
              var terms = window.gigya.utils.templates.fill(
                this.getTemplates().gigyaTerms,
                {
                  lng_Terms: this.getText('terms'),
                }
              );
              // Creating The Footer
              footer = window.gigya.utils.templates.fill(
                this.getTemplates().footer,
                {
                  gigyaTerms: terms,
                  gigyaBrand: brand,
                }
  ...
  \*******************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.connectedSocialProvider = __webpack_require__(
          /*! ./templates/connectedSocialProvider.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/connectedSocialProvider.html'
        );
        exports.defaultPhotoURL = __webpack_require__(
          /*! ./templates/defaultPhotoURL.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/defaultPhotoURL.html'
        );
        exports.disconnectedSocialProvider = __webpack_require__(
          /*! ./templates/disconnectedSocialProvider.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/disconnectedSocialProvider.html'
        );
        exports.edit = __webpack_require__(
          /*! ./templates/edit.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/edit.html'
        );
        exports.footer = __webpack_require__(
          /*! ./templates/footer.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/footer.html'
        );
        exports.gigyaBrand = __webpack_require__(
          /*! ./templates/gigyaBrand.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/gigyaBrand.html'
        );
        exports.gigyaTerms = __webpack_require__(
          /*! ./templates/gigyaTerms.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/gigyaTerms.html'
        );
        exports.identityBirthDate = __webpack_require__(
          /*! ./templates/identityBirthDate.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/identityBirthDate.html'
        );
        exports.identityCity = __webpack_require__(
          /*! ./templates/identityCity.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/identityCity.html'
        );
        exports.identityCountry = __webpack_require__(
          /*! ./templates/identityCountry.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/identityCountry.html'
        );
        exports.socialProviderApps = __webpack_require__(
          /*! ./templates/socialProviderApps.html */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/templates/socialProviderApps.html'
        );
  ...
  \*****************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        var result = __webpack_require__(
          /*! !../../../../../../node_modules/css-loader/dist/cjs.js!./global.css */ '../node_modules/css-loader/dist/cjs.js!./src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/css/global.css'
        );
  ...
  \***********************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function (
          ...
          Object.defineProperty(exports, '__esModule', { value: true });
          var Gigya_PluginsEditConnections = __webpack_require__(
            /*! src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/EditConnections */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/EditConnections.ts'
          );
          var HtmlResources = __webpack_require__(
            /*! src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/HtmlResources */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/HtmlResources.ts'
          );
          var CSSResource = __webpack_require__(
            /*! src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/CSSResources */ './src/socialize/Gigya.Js.Plugin.EditConnectionsNew/app/CSSResources.ts'
          );
          if (!window.gigya._) {
            window.gigya._ = {};
          }
  ...
  \**********************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<div class="gig-edit-connections">\n    <ul role="listbox">\n        $providersData\n    </ul>\n</div>\n$footer\n';
  ...
  \************************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<div class="gig-edit-connections-footer">\n    $gigyaTerms\n    $gigyaBrand\n</div>\n';
  ...
  \***********************************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<span class="gig-edit-connections-information-details-row">$lng_Date_of_birth $day/$month/$year</span>';
  ...
  \******************************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<span class="gig-edit-connections-information-details-row">$lng_City $city </span>';
  ...
  \*********************************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<span class="gig-edit-connections-information-details-row">$lng_Country $country </span>';
  ...
  \************************************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<a href="$providerAppUrl" class="gig-edit-connections-provider-apps" target="_blank"><span>$lng_Myapps</span></a>\n';
