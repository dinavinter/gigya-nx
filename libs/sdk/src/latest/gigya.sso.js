/******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = './src/fidm/Gigya.JS.SSO/app/index.ts')
  );
  /******/
})(
  /************************************************************************/
  ...
  \********************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var sso_1 = __webpack_require__(
          /*! ./sso */ './src/fidm/Gigya.JS.SSO/app/sso.ts'
        );
        ...
        var ssoUtils_1 = __webpack_require__(
          /*! ./ssoUtils */ './src/fidm/Gigya.JS.SSO/app/ssoUtils.ts'
        );
              ...
              switch (_e.label) {
                ...
                case 1:
                  ...
                  if (fullyDecodedQueryString.match(/apikey=/gi).length > 1) {
                    window.gigya.logger.error(
                      'multiple apiKeys in query string are not allowed'
                    );
                    return [2 /*return*/];
                  }
                  ...
                  apiKey = window.gigya.apiKey;
                  configHostname =
                    ((_a = window.location) === null || _a === void 0
                      ? void 0
                      : _a.hostname) || domains_1.getStorageDomain();
                  return [
                    4 /*yield*/,
                    apiBootstrap_1.getSdkConfig(configHostname, 3),
                  ];
                case 2:
                    ...
                    toggles: {
                      linkAccountV2:
                        (_b = webSdkConfig.toggles) === null || _b === void 0
                          ...
                          : _b.linkAccountV2,
                      httpStatusCodes:
                        (_c = webSdkConfig.toggles) === null || _c === void 0
                          ? void 0
                          : _c.httpStatusCodes,
                    },
                    consent: {
                      hasLicense:
                        (_d = webSdkConfig.hasConsentLicense) !== null &&
                        _d !== void 0
                          ? _d
                          : false,
                    },
                  ...
                  return [
                    4 /*yield*/,
                    new gigya.Promise(function (r) {
                      return functions_1.invokeOnPageLoad(r);
                    }),
                  ];
                case 3:
                  // waiting for async page load (we want to preserve stack trace in case of exceptions during sso.init)
                  _e.sent();
                  ssoService = new sso_1.Sso(
                    apiKey,
                    params.sourceKey,
                    params.ssoSegment,
                    webSdkConfig.sso,
