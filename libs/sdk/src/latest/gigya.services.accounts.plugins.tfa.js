/******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = './src/accounts/Gigya.Js.Plugin.Tfa/app/index.ts')
  );
  /******/
})(
  /************************************************************************/
...
***************************************************************************** */
  ...
  \************************************************************/
      ...
      /***/ function (module, exports) {
        ...
        exports.defaultCss = {
          ...
          resetRtl:
            '.gig-comments-container *, *.gig-comments-container {direction:rtl;text-align:right;}',
          global: [
            '.gig-tfa-container {}',
          ...
          mobile: [
            '.gig-tfa-container *, *.gig-tfa-container {font-size:16px;-webkit-text-size-adjust:none;}',
          ].join(''),
          nonMobile: [
            '.gig-tfa-container *, *.gig-tfa-container {font-size:12px}',
          ].join(''),
          rtl: [].join(''),
        };
  ...
  \***********************************************************/
      ...
      /***/ function (module, exports) {
        ...
        exports.defaultTemplates = {
          container: [
            '<div class="gig-tfa-select-provider"></div>',
            '<div class="gig-tfa-provider-wrapper" id="$wrapperId"></div>',
          ].join(''),
          selectProvider: [
          ...
          error: [
            '<div>',
            '<div tabindex="0" class="gig-tfa-error"></div>',
            '</div>',
          ].join(''),
          phoneRegister: [
          ...
          phoneEdit: [
            '<div class="gig-tfa-phone-edit-header-text">$headerText</div>',
            '<div class="gig-tfa-phone-edit-numbers"></div>',
          ].join(''),
          phoneEditEntry: [
  ...
  \***********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function (
          ...
          Object.defineProperty(exports, '__esModule', { value: true });
          var Templates_1 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/Templates */ './src/accounts/Gigya.Js.Plugin.Tfa/app/Templates.ts'
          );
          var DefaultCss_1 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/DefaultCss */ './src/accounts/Gigya.Js.Plugin.Tfa/app/DefaultCss.ts'
          );
          var TfaProviderFactory_1 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviderFactory */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviderFactory.ts'
          );
          ...
          exports.FriendlyProviderName = function (provider) {
            switch (provider.name) {
              case 'livelink':
                return 'Phone (SMS)';
              case 'gigyaPhone':
                return Boolean(provider.capabilities)
                  ? 'Phone (' + provider.capabilities.join('/') + ')'
                  : 'Phone';
              case 'gigyaTotp':
                return 'Time based Authentication';
              case 'gigyaPush':
                return 'Push Notification';
              case 'gigyaEmail':
                return 'Email';
              default:
                return 'Unknown TFA Provider';
            }
          };
          var TfaPlugin = /** @class */ (function () {
            function TfaPlugin(params) {
              ...
              this.templates = window.gigya.utils.object.clone(
                Templates_1.defaultTemplates,
                false
              );
            ...
            TfaPlugin.prototype.getText = function (
              textKey,
              replaceStr,
              withStr
            ) {
              if (
                ...
                this.params['customLang'][textKey]
              ) {
                return this.params['customLang'][textKey].replace(
                  replaceStr,
                  withStr
                );
              } else {
                return window.gigya.pluginUtils.lang.getLocalizedText(
                  'gigya.services.accounts.plugins.tfa.js',
                  textKey,
                  this.params['lang'],
                  replaceStr,
                  withStr
            ...
            TfaPlugin.prototype.initUI = function () {
              ...
              if (cssPrefix || !this.addedCss) {
                ...
                window.gigya._.plugins.utils.css.addCss(
                  DefaultCss_1.defaultCss.reset,
                  cssPrefix
                );
                if (this.isRtl)
                  window.gigya._.plugins.utils.css.addCss(
                    DefaultCss_1.defaultCss.resetRtl,
                    cssPrefix
                  );
                var fixedCss = window.gigya.pluginUtils.css.fixCss(
                  DefaultCss_1.defaultCss.global
                );
                var fixedRtlCss = window.gigya.pluginUtils.css.fixCss(
                  DefaultCss_1.defaultCss.rtl
                );
                ...
                if (this.isMobileUI) {
                  window.gigya._.plugins.utils.css.addCss(
                    DefaultCss_1.defaultCss.mobile,
                    cssPrefix
                  );
                } else {
                  window.gigya._.plugins.utils.css.addCss(
                    DefaultCss_1.defaultCss.nonMobile,
                    cssPrefix
                  );
                }
                if (
                  window.gigya.localInfo.isMobile &&
                  window.gigya.localInfo.isSafari
                ) {
                  window.gigya._.plugins.utils.css.addCss(
                    '.gig-tfa-container * {-webkit-text-size-adjust:none;}',
                    cssPrefix
                  );
                }
                this.addedCss = true;
              ...
              this.container.innerHTML = window.gigya.utils.templates.fill(
                ...
                { wrapperId: this.container.id + '_wrapper' }
              );
            };
            TfaPlugin.prototype.showProgress = function () {
              if (this.selectedProvider && this.selectedProvider.container) {
                window.gigya.global.showLoader(
                  this.selectedProvider.container,
                  'gig-tfa-provider-loader'
                );
              }
            };
            TfaPlugin.prototype.hideProgress = function () {
              var progressEl = this.container.querySelector(
                '.gig-tfa-provider-loader'
              );
              if (progressEl) window.gigya.utils.DOM.removeElement(progressEl);
            };
            ...
            TfaPlugin.prototype.initTfa = function (
              provider,
              mode,
              initCallback
            ) {
            ...
            TfaPlugin.prototype.startProviderFlow = function (provider, mode) {
              var _this = this;
              var providerContainer = window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gig-tfa-provider-wrapper'
              )[0];
              this.selectedProvider =
                TfaProviderFactory_1.getTfaProviderInstance(
                  provider.name,
                  this,
                  providerContainer,
                  this.params,
                  mode,
                  function (response, providerAssertion, isTemp) {
                    _this.onProviderCallback(
                      response,
                      providerAssertion,
                      isTemp
                    );
            ...
            TfaPlugin.prototype.showProvider = function (provider, mode) {
              ...
              this.initTfa(
                provider.name,
                mode == TfaMode.edit ? TfaMode.verify : mode,
                function (response) {
            ...
            TfaPlugin.prototype.onProviderCallback = function (
              response,
              providerAssertion,
              isTemp
            ) {
            ...
            TfaPlugin.prototype.showSelector = function (mode) {
              ...
              supportedProviders = supportedProviders.map(function (provider) {
                return __webpack_provided_Object_dot_assign(provider, {
                  displayName: exports.FriendlyProviderName(provider),
                });
              });
            ...
            TfaPlugin.prototype.showProviderSelector = function (
              providers,
              mode
            ) {
              var _this = this;
              ...
              var selectContainer = this.container.querySelector(
                '.gig-tfa-select-provider'
              );
              selectContainer.innerHTML = window.gigya.utils.templates.fill(
                this.templates['selectProvider'],
                {
                  selectProviderHeader: this.getText('select_provider'),
                }
              );
              var providerSelector =
                this.container.querySelector('.gig-tfa-selectbox');
              providers
                ...
                .forEach(function (option) {
                  return providerSelector.add(option);
                });
              window.gigya.utils.DOM.addEventListener(
                ...
                function (e) {
                  ...
                  _this.showProvider(
                    window.gigya.utils.array.first(
                      supportedProviders,
                      function (p) {
                        return (
            ...
            TfaPlugin.prototype.getSupportedProviders = function (mode) {
              ...
              return providers.filter(function (p) {
                return TfaProviderFactory_1.isTfaProviderSupported(p.name);
              });
            };
            ...
            TfaPlugin.prototype.getEditableProviders = function () {
              ...
              for (var i = 0; i <= this.activeProviders.length - 1; i++) {
                var isEditable = this.isTfaProviderEditable(
                  this.activeProviders[i].name
                );
                if (isEditable) {
            ...
            TfaPlugin.prototype.isTfaProviderEditable = function (
              providerToCheck
            ) {
              // go over the list of editable providers
              return (
                constants_1.EditableTfaProvidersTypes[providerToCheck] !=
                undefined
              );
            };
  ...
  \********************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        Object.defineProperty(exports, '__esModule', { value: true });
        var GigyaPhoneProvider_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/GigyaPhoneProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/GigyaPhoneProvider.ts'
        );
        var LiveLinkPhoneProvider_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/LiveLinkPhoneProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/LiveLinkPhoneProvider.ts'
        );
        var EmailTfaProvider_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/EmailTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/EmailTfaProvider.ts'
        );
        var TotpTfaProvider_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/TotpTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/TotpTfaProvider.ts'
        );
        var PushTfaProvider_1 = __webpack_require__(
          /*! ./TfaProviders/PushTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/PushTfaProvider.ts'
        );
        var tfaProviders = {
        ...
        function getTfaProviderInstance(
          providerName,
          plugin,
          container,
          params,
          ...
          return tfaProviders[providerName]
            ? new tfaProviders[providerName](
                plugin,
                container,
                params,
                mode,
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var BaseTfaProvider = /** @class */ (function () {
          function BaseTfaProvider(
            ...
            if (restartFlowInterval === void 0) {
              restartFlowInterval = constants_1.gigyaAssertionExpiration;
            }
            this.plugin = plugin;
          ...
          BaseTfaProvider.prototype.showError = function (
            error,
            errorElements
          ) {
            if (errorElements === void 0) {
              errorElements = [];
            }
            var errorContainer = this.container.querySelector(
              'div.gig-tfa-error.submit-error'
            );
            if (!errorContainer) {
              this.container.appendChild(
                window.gigya.utils.DOM.createElementFromTemplate(
                  this.plugin.templates['error']
                )
              );
              errorContainer =
                this.container.querySelector('div.gig-tfa-error');
            }
          ...
          BaseTfaProvider.prototype.isInDOM = function () {
            return Boolean(
              this.container &&
                ...
                document.getElementById(this.container.parentElement.id)
            );
          };
  ...
  \*******************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var BaseTfaProvider_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/BaseTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/BaseTfaProvider.ts'
        );
        var Utils_1 = __webpack_require__(
          /*! ../helpers/Utils */ './src/accounts/Gigya.Js.Plugin.Tfa/app/helpers/Utils.ts'
        );
        ...
        var EmailTfaProvider = /** @class */ (function (_super) {
          ...
          EmailTfaProvider.prototype.sendVerificationCodeToEmail = function (
            email
          ) {
            var _this = this;
            this.phvToken = null;
            ...
            window.gigya.accounts.tfa.email.sendVerificationCode(
              tslib_1.__assign(tslib_1.__assign({}, this.params), {
                lang: this.params['communicationLang'],
              }),
              verificationParams
            );
          };
          EmailTfaProvider.prototype.showEnterCode = function (email) {
            var _this = this;
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['emailEnterCode'],
              {
                id: this.container.id,
                headerText: this.plugin.getText(
                  'a_verification_code_has_been_sent_to_colon'
                ),
                enter_code: this.plugin.getText('enter_code_colon'),
                remember_this_device: this.plugin.isMobileUI
                  ? this.plugin.getText('remember_this_device')
                  : this.plugin.getText('remember_this_computer'),
                submit: this.plugin.getText('submit'),
              }
            );
            var submitButton = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-button-submit'
            )[0];
            var tbCode = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-code-textbox'
            )[0];
            var cbRemember = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-code-remember-checkbox'
            )[0];
            var emailText = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-email-text'
            )[0];
            var divError = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-error'
            )[0];
          ...
          EmailTfaProvider.prototype.sendTfaCode = function (
            tbCode,
            isChecked
          ) {
            var _this = this;
            if (this.phvToken) {
              var submitButton_1 = window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gig-tfa-button-submit'
              )[0];
              window.gigya.utils.DOM.addClassToElement(
              ...
              window.gigya.accounts.tfa.email.completeVerification(
                this.params,
                {
                  ...
                  callback: function (response) {
                    if (response['errorCode'] == 0) {
                      ...
                      _this.onDone(
                        response,
                        response.providerAssertion,
                        !isChecked
                      );
                    } else if (
                      response['errorCode'] == GSErrors_1.GSErrors.LIMIT_REACHED
                    ) {
                      _this.showError(_this.plugin.getText('limit_reached'), [
                        tbCode,
                      ]);
                    } else {
                      _this.showError(
                        _this.plugin.getText('please_enter_a_valid_code'),
                        [tbCode]
                      );
                      window.gigya.utils.DOM.removeClassFromElement(
                        submitButton_1,
          ...
          EmailTfaProvider.prototype.onDone = function (
            response,
            providerAssertion,
            isTemp
          ) {
  ...
  \*********************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var PhoneTfaProvider_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/PhoneTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/PhoneTfaProvider.ts'
        );
        var TfaPlugin_1 = __webpack_require__(
          /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaPlugin */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaPlugin.ts'
        );
        var GigyaPhoneProvider = /** @class */ (function (_super) {
          tslib_1.__extends(GigyaPhoneProvider, _super);
          function GigyaPhoneProvider(
            plugin,
            container,
            params,
            mode,
            ...
            var _this =
              _super.call(this, plugin, container, params, mode, callback) ||
              this;
            _this.name = 'gigyaPhone';
            _this.supportedSendMethods = [
              TfaPlugin_1.VerificationMethod.SMS,
              TfaPlugin_1.VerificationMethod.VOICE,
            ];
            return _this;
          }
  ...
  \************************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var LiveLinkPhoneProvider = /** @class */ (function (_super) {
          ...
          function LiveLinkPhoneProvider(
            plugin,
            container,
            params,
            mode,
          ...
          LiveLinkPhoneProvider.prototype.updateNumbers = function (callback) {
            ...
            _super.prototype.updateNumbers.call(this, function () {
              ...
              _this.phoneNumbers.forEach(function (phone) {
                return (phone.lastMethod = 'sms');
              });
              callback();
            });
          };
  ...
  \*******************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var FlagService_1 = __webpack_require__(
          /*! ../../../../core/Gigya.Js/app/Services/FlagService */ './src/core/Gigya.Js/app/Services/FlagService.ts'
        );
        var PhoneTfaProvider = /** @class */ (function (_super) {
          tslib_1.__extends(PhoneTfaProvider, _super);
          function PhoneTfaProvider(
            plugin,
            container,
            params,
            mode,
          ...
          PhoneTfaProvider.prototype.startFlow = function (capabilities) {
            ...
            if (capabilities && capabilities.length > 0) {
              this.supportedSendMethods = capabilities
                ...
                .map(function (cap) {
                  return TfaPlugin_1.VerificationMethod[cap];
                });
            } else {
          ...
          PhoneTfaProvider.prototype.showEdit = function () {
            var _this = this;
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['phoneEdit'],
              {
                headerText: this.plugin.getText(
            ...
            var numbersContainer = window.gigya.utils.DOM.getElementsByClass(
              this.container,
            ...
            for (var i = 0; i < this.phoneNumbers.length; i++) {
              ...
              var phoneHtml = window.gigya.utils.templates.fill(
                this.plugin.templates['phoneEditEntry'],
                {
            ...
            var onEditClick = function (e) {
              ...
              var phone = _this.getPhoneById(
                editLink.getAttribute('data-phoneid')
              );
              _this.plugin.initTfa(
                _this.name,
                TfaPlugin_1.TfaMode.edit,
                function (response) {
                  if (response['errorCode'] == 0) {
                    _this.updateNumbers(function () {
                      _this.hideProgress();
                      _this.showEnterPhoneNumber(
                        TfaPlugin_1.TfaMode.edit,
                        _this.getPhoneById(phone.id)
                      );
                    });
                  } else {
            ...
            var editLinks = window.gigya.utils.DOM.getElementsByClass(
              this.container,
          ...
          PhoneTfaProvider.prototype.showEnterPhoneNumber = function (
            mode,
            phone
          ) {
            var _this = this;
            if (mode === void 0) {
              mode = TfaPlugin_1.TfaMode.register;
            }
            var hText = this.plugin.getText(
            ...
            if (mode == TfaPlugin_1.TfaMode.edit) {
              hText = this.plugin.getText(
                'edit_your_phone_number_where_verification_codes_will_be_received_colon'
              );
            }
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['phoneRegister'],
              {
                id: this.container.id,
                headerText: hText,
                select_your_country: this.plugin.getText(
                  'select_your_country_colon'
                ),
                enter_your_phone_number: this.plugin.getText(
            ...
            var nextButton = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-button-next'
            )[0];
            var prefixSelect = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-register-select'
            )[0];
            var tbPhonePrefix = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-prefix'
            )[0];
            var tbPhoneNumber = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-number'
            )[0];
            var typesRadios = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-register-type-radio'
            );
            var countryErrorDiv = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'country_err'
            )[0];
            var phoneErrorDiv = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'phone_err'
            )[0];
            var requiredErrorTxt = this.plugin.getText(
            ...
            window.gigya.utils.DOM.addEventListener(
              ...
              function () {
                _this.hideError();
                var selectedPrefix =
                  prefixSelect.options[prefixSelect.selectedIndex];
                if (selectedPrefix) {
            ...
            window.gigya.utils.DOM.addEventListener(
              ...
              function () {
                ...
                if (
                  tbPhonePrefix.value == '0' ||
                  !tbPhonePrefix.value ||
                  !tbPhoneNumber.value
                ) {
                  if (
                    (!tbPhonePrefix.value || !tbPhonePrefix.value) &&
                    countryErrorDiv
                  ) {
                    _this.setError(countryErrorDiv, requiredErrorTxt);
                  }
            ...
            window.gigya.pluginUtils.DOM.setTextboxSubmitButton(
              tbPhoneNumber,
              nextButton
            );
            Utils_1.createActionInterval(
              this,
              function (count) {
              ...
              function () {
                return !tbPhoneNumber || !tbPhoneNumber.parentElement;
              }
            );
          ...
          PhoneTfaProvider.prototype.showVerify = function () {
            if (this.phoneNumbers.length > 0) {
              ...
              this.sendVerificationCodeToPhone(
                phone,
                TfaPlugin_1.TfaMode.verify,
                phone.lastMethod
              );
            }
          };
          PhoneTfaProvider.prototype.showEnterCode = function (
            phone,
            mode,
            method
          ) {
            var _this = this;
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['phoneEnterCode'],
              {
                id: this.container.id,
                headerText:
                  method == 'sms'
                ...
                resend:
                  mode == TfaPlugin_1.TfaMode.verify
                    ? this.plugin.getText("didn't_get_the_code_qm")
                    : this.plugin.getText('change_resend'),
                enter_code: this.plugin.getText('enter_code_colon'),
                remember_this_device: this.plugin.isMobileUI
                  ? this.plugin.getText('remember_this_device')
                  : this.plugin.getText('remember_this_computer'),
            ...
            var resendLink = window.gigya.utils.DOM.getElementsByClass(
              this.container,
            ...
            var phonenumber = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-code-phonenumber'
            )[0];
            var divError = window.gigya.utils.DOM.getElementsByClass(
            ...
            var resendAction = function () {
              _this.plugin.initTfa(_this.name, mode, function () {
                if (
                  mode == TfaPlugin_1.TfaMode.register ||
                  mode == TfaPlugin_1.TfaMode.add ||
                  mode == TfaPlugin_1.TfaMode.edit
                ) {
          ...
          PhoneTfaProvider.prototype.sendTfaCode = function (
            tbCode,
            cbRemember
          ) {
            var _this = this;
          ...
          PhoneTfaProvider.prototype.showResend = function (mode, phone) {
            var _this = this;
            var headerText =
              this.supportedSendMethods.length >= 2
                ? this.plugin.getText(
                    'choose_how_to_receive_the_verification_code_colon'
                  )
                : '';
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['phoneResend'],
              {
                id: this.container.id,
                ...
                voice_call: this.plugin.getText('voice_call'),
                send: this.plugin.getText('get_the_code'),
                your_phone_number: this.plugin.getText(
                  'your_phone_number_colon'
                ),
              }
            );
            this.showVerificationMethods();
            var sendButton = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-button-send'
            )[0];
            var divPhoneNumber = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-resend-yourphone'
            )[0];
            var typesRadios = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-phone-resend-type-radio'
            );
            for (var i = 0; i < typesRadios.length; i++) {
          ...
          PhoneTfaProvider.prototype.showVerificationMethods = function () {
            var verificationMethodSection =
              window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gig-tfa-verification-method'
              );
            if (
              verificationMethodSection.length &&
              verificationMethodSection[0].style &&
              this.supportedSendMethods.length >= 2
            ) {
              verificationMethodSection[0].style.display = '';
            } else {
              var buttonContainer = window.gigya.utils.DOM.getElementsByClass(
                this.container,
          ...
          PhoneTfaProvider.prototype.updateNumbers = function (callback) {
            var _this = this;
            if (
              this.mode == TfaPlugin_1.TfaMode.add ||
              this.mode == TfaPlugin_1.TfaMode.edit ||
              this.mode == TfaPlugin_1.TfaMode.verify
            ) {
              this.showProgress();
              window.gigya.accounts.tfa.phone.getRegisteredPhoneNumbers(
                this.params,
                {
                  callback: function (response) {
                    _this.hideProgress();
          ...
          PhoneTfaProvider.prototype.sendVerificationCodeToPhone = function (
            phone,
            mode,
            method
          ) {
              ...
              callback: function (response) {
                switch (response.errorCode) {
                  ...
                  case GSErrors_1.GSErrors.Extension_Point_Custom_Error:
                    _this.showError(
                      response.errorDetails || response.errorMessage
                    );
                    break;
                  default:
                    _this.showError(
                      _this.plugin.getText(
            ...
            this.phvToken = null;
            window.gigya.accounts.tfa.phone.sendVerificationCode(
              tslib_1.__assign(tslib_1.__assign({}, this.params), {
                lang: this.params['communicationLang'],
              }),
              verificationParams
          ...
          PhoneTfaProvider.prototype.completeVerification = function (
            phvToken,
            code,
            callback
          ) {
          ...
          PhoneTfaProvider.prototype.onDone = function (
            response,
            providerAssertion,
            isTemp
          ) {
          ...
          PhoneTfaProvider.prototype.setAreaCodesTranslation = function () {
              ...
              Array.from(
                ((_b =
                  (_a = this.container) === null || _a === void 0
                    ? void 0
                    : _a.querySelector('select')) === null || _b === void 0
                  ? void 0
                  : _b.options) || []
              ) || [];
            for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
              ...
              if (
                !FlagService_1.FlagService.fixPhoneTFATranslations &&
                option.value === '0'
              ) {
                option.innerHTML = '- Select -';
                continue;
              }
              option.innerHTML = this.plugin.getText(
                (_c =
                  option === null || option === void 0
                    ? void 0
                    : option.innerHTML) === null || _c === void 0
                  ? void 0
                  : _c.replace('$', '')
              );
            }
  ...
  \******************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var BackupCodesManager_1 = __webpack_require__(
          /*! ../helpers/BackupCodesManager */ './src/accounts/Gigya.Js.Plugin.Tfa/app/helpers/BackupCodesManager.ts'
        );
        var Utils_1 = __webpack_require__(
          /*! ../helpers/Utils */ './src/accounts/Gigya.Js.Plugin.Tfa/app/helpers/Utils.ts'
        );
        ...
        var PushTfaProvider = /** @class */ (function (_super) {
          ...
          function PushTfaProvider(
            ...
            if (_pollingLimitMillis === void 0) {
              _pollingLimitMillis = PollingLimitMillis;
            }
            if (_pollingIntervalMillis === void 0) {
            ...
            _this.resendPushNotificationClickHandler = function () {
              ...
              _this.plugin.initTfa(_this.name, _this.mode, function (res) {
                if (res['errorCode'] == 0) {
                  _this.plugin.startProviderFlow(
                    { name: _this.name },
                    _this.mode
                  );
                } else {
                  // should not happen
                  _this.onError('initTfa failed', {
                    method: 'resendPushNotificationClickHandler',
                    res: res,
                  });
                }
              });
            ...
            _this.useBackupCodesClickHandler = function () {
              _this.stopPolling();
              _this.container.innerHTML = window.gigya.utils.templates.fill(
                _this.plugin.templates['pushVerificationBackupCodes'],
                {
                  id: _this.container.id,
                  call_to_action: _this.plugin.getText('enter_backup_code'),
                  resendPushNotification: _this.plugin.getText(
                    'resend_push_notification'
                  ),
                  useBackupCode: _this.plugin.getText(
              ...
              window.gigya.utils.DOM.addEventListener(
                ...
                'click',
                _this.resendPushNotificationClickHandler
              );
              window.gigya.utils.DOM.addEventListener(
                submitButton,
                'click',
                _this.submitBackupCodeClickHandler
              );
            ...
            if (!_this._backupCodesManager)
              _this._backupCodesManager =
                new BackupCodesManager_1.BackupCodesManager(_this);
            return _this;
          }
          PushTfaProvider.prototype.checkIsVerified = function () {
            ...
            window.gigya.accounts.tfa.push.isVerified({
              ...
              callback: function (res) {
                return _this.onIsVerifiedResponse(res);
              },
            });
          };
          PushTfaProvider.prototype.onIsVerifiedResponse = function (res) {
            ...
            if (res.errorCode != GSErrors_1.GSErrors.OK)
              return this.onError('failed to check push verification state', {
                method: 'isVerified',
                res: res,
              });
            // success
            if (res.providerAssertion) return this.onPushVerified(res);
            // keep polling
            setTimeout(function () {
              if (_this.shouldContinuePolling()) _this.checkIsVerified();
          ...
          PushTfaProvider.prototype.shouldStopPolling = function () {
            ...
            var pollingLimitReached =
              now - this._pollingStartTime >= this._pollingLimitMillis;
          ...
          PushTfaProvider.prototype.onError = function (
            log,
            details,
            errMsgKey
          ) {
            if (errMsgKey === void 0) {
              errMsgKey = 'an_error_has_occurred_please_try_again_later';
            }
            if (log) window.gigya.logger.error(log, details);
            var err = this.plugin.getText(errMsgKey) || 'Error';
            return this.showError(err);
          };
          PushTfaProvider.prototype.onSendVerificationResponse = function (
            res
          ) {
            this.hideProgress();
            if (res['errorCode'] == 0) {
              ...
              this.onError('failed to send push tfa verification', {
          ...
          PushTfaProvider.prototype.startPushVerificationFlow = function () {
            ...
            window.gigya.accounts.tfa.push.sendVerification({
              ...
              regToken: this.params['regToken'],
              callback: function (res) {
                return _this.onSendVerificationResponse(res);
              },
            });
          };
          PushTfaProvider.prototype.showVerifyMode = function () {
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['pushVerificationPhone'],
              {
                id: this.container.id,
                resendPushNotification: this.plugin.getText(
                  'resend_push_notification'
                ),
                call_to_action: this.plugin.getText('push_tfa_call_to_action'),
                useBackupCode: this.plugin.getText(
                  'cant_access_use_backup_codes'
                ),
              }
            );
            ...
            window.gigya.utils.DOM.addEventListener(
              useBackupCodes,
              'click',
              this.useBackupCodesClickHandler
            );
            window.gigya.utils.DOM.addEventListener(
              resendPushNotification,
              'click',
              this.resendPushNotificationClickHandler
            );
            this.plugin.onAfterScreenLoad('tfa-push-verification');
          };
          PushTfaProvider.prototype.getBackupCodeErrorMessage = function (
            response
          ) {
          ...
          PushTfaProvider.prototype.showBackupCodesEditMode = function (
            originalBackupCodes
          ) {
            var _this = this;
            if (originalBackupCodes === void 0) {
              originalBackupCodes = null;
            }
            Utils_1.createActionInterval(
              this,
              function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          ...
                          return [
                            4 /*yield*/,
                            this._backupCodesManager.getBackupCodes(),
                          ];
                        case 1:
                          getBackupCodesResponse = _a.sent();
                          if (
                            getBackupCodesResponse['errorCode'] !==
                              GSErrors_1.GSErrors.OK ||
                            !getBackupCodesResponse.backupCodes
                          ) {
                            this.container.innerHTML =
                              this.plugin.templates['error'];
                            return [
                        ...
                        case 2:
                          this.container.innerHTML =
                            window.gigya.utils.templates.fill(
                              this.plugin.templates['totpBackupCodes'],
                              window.gigya.utils.object.merge([
                                {
                                  headerText: this.plugin.getText(
                                    'print_backup_codes_intro'
                                  ),
                                  print: this.plugin.getText('print'),
                                  generateNewCodes: this.plugin.getText(
                                    'generate_backup_codes'
                                  ),
                                },
                                this._backupCodesManager.prepareBackupCodesForView(
                                  backupCodes
                                ),
                              ])
                            );
                          backupCodesTable =
                            window.gigya.utils.DOM.getElementsByClass(
                              this.container,
                              'gig-tfa-totp-backup-codes'
                            )[0];
                          printButton =
                            window.gigya.utils.DOM.getElementsByClass(
                              this.container,
                              'gig-backup-codes-print-btn'
                            )[0];
                          generateNewCodesLink =
                            window.gigya.utils.DOM.getElementsByClass(
                              this.container,
                              'gig-tfa-generate-new-codes'
                            )[0];
                          ...
                          window.gigya.utils.DOM.addEventListener(
                            ...
                            'click',
                            function () {
                              return _this._backupCodesManager.printBackupCodes(
                                backupCodesTable.outerHTML
                              );
                            }
                          );
                          window.gigya.utils.DOM.addActivationHandler(
                            generateNewCodesLink,
                            function () {
                              return _this.showGenerateNewCodesConfirmation(
                                backupCodes
                              );
                            }
                          );
                          this.plugin.onAfterScreenLoad(
                            'tfa-backup-codes',
                            this.plugin.getText('backup_codes')
                          );
                          return [2 /*return*/];
                      }
                    });
          ...
          PushTfaProvider.prototype.showGenerateNewCodesConfirmation =
            function (originalBackupCodes) {
              var _this = this;
              var template = FlagService_1.FlagService
                .generateNewCodeWcagCompliance
                ? 'totpGenerateNewCodesConfirmationWCAGComply'
                : 'totpGenerateNewCodesConfirmation';
              this.container.innerHTML = window.gigya.utils.templates.fill(
                this.plugin.templates[template],
                {
                  resetCodesQuestion: this.plugin.getText(
              ...
              var confirmButton = window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gig-backup-codes-confirm'
              )[0];
              var cancelButton = window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gig-backup-codes-cancel'
              )[0];
              confirmButton.focus();
              window.gigya.utils.DOM.addEventListener(
                confirmButton,
                      ...
                      return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                          case 0:
                            ...
                            return [
                              4 /*yield*/,
                              this._backupCodesManager.generateNewCodes(),
                            ];
                          case 1:
                            generateBackupCodesResponse = _a.sent();
                            if (
                              generateBackupCodesResponse['errorCode'] !==
                                GSErrors_1.GSErrors.OK ||
                              !generateBackupCodesResponse.backupCodes
                            ) {
                              this.container.innerHTML =
                                this.plugin.templates['error'];
                              return [
              ...
              window.gigya.utils.DOM.addEventListener(
                ...
                'click',
                function () {
                  return _this.showBackupCodesEditMode(originalBackupCodes);
                }
              );
              this.plugin.onAfterScreenLoad(
                'tfa-backup-codes-regenerate',
                this.plugin.getText('backup_codes')
              );
            };
          PushTfaProvider.prototype.getSubmitButton = function () {
            return Utils_1.getElementByClassName(
              this.container,
              'gig-tfa-button-submit'
            );
          };
  ...
  \******************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var TotpTfaProvider = /** @class */ (function (_super) {
                ...
                return tslib_1.__awaiter(_this, void 0, void 0, function () {
                  ...
                  return tslib_1.__generator(this, function (_a) {
                    ...
                    afterInitTFA = function (initTFAResponse) {
                      if (
                        initTFAResponse &&
                        initTFAResponse['errorCode'] !== GSErrors_1.GSErrors.OK
                      )
                        return;
                      window.gigya.accounts.tfa.totp.register(_this.params, {
                        callback: function (response) {
                          if (
                            ...
                            _this.renderRegistrationProcess(
                              response['qrCode'],
                              response['sctToken']
                            );
                            if (count > 1) {
                              _this.showError(
                                _this.plugin.getText('totp_session_expired')
                              );
                            }
                          }
                        },
          ...
          TotpTfaProvider.prototype.showVerifyMode = function (
            usingBackupCode
          ) {
            var _this = this;
            if (usingBackupCode === void 0) {
              usingBackupCode = false;
            }
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['totpVerify'],
              {
                id: this.container.id,
                enter_code: usingBackupCode
                  ? this.plugin.getText('enter_backup_code')
                  : this.plugin.getText('enter_totp_code'),
                remember_this_device: this.plugin.isMobileUI
                  ? this.plugin.getText('remember_this_device')
                  : this.plugin.getText('remember_this_computer'),
                submit: this.plugin.getText('submit'),
                useBackupCode: usingBackupCode
                  ? this.plugin.getText('enter_totp_code')
                  : this.plugin.getText('cant_access_use_backup_codes'),
              }
            );
            this.renderVerificationSection(usingBackupCode);
            var useBackupCodeLink = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-use-backup-code'
            );
            window.gigya.utils.DOM.addActivationHandler(
              useBackupCodeLink[0],
              function () {
                return _this.showVerifyMode(!usingBackupCode);
              }
            );
          ...
          TotpTfaProvider.prototype.showEditMode = function () {
            var _this = this;
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['totpEdit'],
              {
                headerText: this.plugin.getText(
            ...
            var changeDeviceButton = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-button-change-device'
            )[0];
            var backupCodesButton = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gig-tfa-button-backup-codes'
            )[0];
            changeDeviceButton.focus();
            window.gigya.utils.DOM.addActivationHandler(
              changeDeviceButton,
              function () {
                return _this.showChangeDeviceScreen();
              }
            );
            window.gigya.utils.DOM.addActivationHandler(
              backupCodesButton,
              function () {
                return _this.showBackupCodesScreen();
              }
            );
            this.plugin.onAfterScreenLoad(
              'tfa-edit',
              this.plugin.getText('totp_verification_settings')
            );
          };
          TotpTfaProvider.prototype.showBackupCodesScreen = function (
            originalBackupCodes
          ) {
            var _this = this;
            if (originalBackupCodes === void 0) {
                  ...
                  function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                      ...
                      this.plugin.initTfa(
                        this.name,
                        TfaPlugin_1.TfaMode.edit,
                        function (initTFAResponse) {
                          if (
                            initTFAResponse &&
                            initTFAResponse['errorCode'] !==
                              GSErrors_1.GSErrors.OK
                          )
                            return;
                          window.gigya.accounts.tfa.totp.register(
                            _this.params,
                            {
                              callback: function (response) {
                                if (
                                  ...
                                  _this.renderRegistrationProcess(
                                    response['qrCode'],
                                    response['sctToken'],
                                    'tfa-totp-change-device',
                                    _this.plugin.getText('totp_change_device')
                                  );
                                  if (count > 1) {
                                    _this.showError(
                                      _this.plugin.getText(
          ...
          TotpTfaProvider.prototype.showGenerateNewCodesConfirmation =
            function (originalBackupCodes) {
              var _this = this;
              var template = FlagService_1.FlagService
                .generateNewCodeWcagCompliance
              ...
              window.gigya.utils.DOM.addActivationHandler(
                cancelButton,
                function () {
                  return _this.showBackupCodesScreen(originalBackupCodes);
                }
              );
              this.plugin.onAfterScreenLoad(
                'tfa-backup-codes-regenerate',
          ...
          TotpTfaProvider.prototype.sendTfaCode = function (
            tbCode,
            cbRemember,
            submitButton,
            isBackupCode
          ...
          TotpTfaProvider.prototype.verify = function (
            code,
            isTemp,
            sctToken,
            isBackupCode
            ...
            return new gigya.Promise(function (resolve, reject) {
              var localParams = {
                ...
                callback: function (response) {
                  ...
                  if (response['errorCode'] == 0) {
                    ...
                    response['errorDetails'] === 'Wrong verification code'
                  ) {
              ...
              if (isBackupCode) {
                window.gigya.accounts.tfa.backupcodes.verify(
                  _this.params,
                  localParams
                );
              } else {
                window.gigya.accounts.tfa.totp.verify(
                  _this.params,
                  localParams
                );
              }
          ...
          TotpTfaProvider.prototype.renderRegistrationProcess = function (
            qrCode,
            sctToken,
            screenName,
            caption
            ...
            if (screenName === void 0) {
              screenName = 'tfa-totp-registration';
            }
            this.sctToken = sctToken;
            this.container.innerHTML = window.gigya.utils.templates.fill(
              this.plugin.templates['totpRegister'],
              {
                id: this.container.id,
                ...
                remember_this_device: this.plugin.isMobileUI
                  ? this.plugin.getText('remember_this_device')
                  : this.plugin.getText('remember_this_computer'),
                downloadBackupCodesIntro: this.plugin.getText(
          ...
          TotpTfaProvider.prototype.renderVerificationSection = function (
            usingBackupCode
          ) {
            var _this = this;
            if (usingBackupCode === void 0) {
          ...
          TotpTfaProvider.prototype.waitForQRImageToRender = function () {
            var _this = this;
            return new gigya.Promise(function (resolve, reject) {
              var imgWrapper = window.gigya.utils.DOM.getElementsByClass(
                _this.container,
                'gig-tfa-totp-qrcode'
              );
              if (imgWrapper[0]) {
                ...
                } else reject('TOTP: missing qrCode image element');
              } else reject('TOTP: missing qrCode image element');
            });
          };
  ...
  \****************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var TfaPlugin_1 = __webpack_require__(
          /*! ../TfaPlugin */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaPlugin.ts'
        );
        var BackupCodesManager = /** @class */ (function () {
                  ...
                  case 0:
                    return [
                      ...
                      new gigya.Promise(function (resolve) {
                        _this._tfaProvider.plugin.initTfa(
                          _this._tfaProvider.name,
                          TfaPlugin_1.TfaMode.edit,
                          function (initTFAResponse) {
                            if (
                              initTFAResponse &&
                              ...
                              return;
                            window.gigya.accounts.tfa.backupcodes.get(
                              _this._tfaProvider.params,
                              {
                                callback: resolve,
                              }
                            );
                        ...
                        _this._tfaProvider.plugin.initTfa(
                          ...
                          function (initTFAResponse) {
                            if (
                              ...
                              return;
                            window.gigya.accounts.tfa.backupcodes.create(
                              _this._tfaProvider.params,
                              {
                                callback: resolve,
                              }
          ...
          BackupCodesManager.prototype.prepareBackupCodesForView = function (
            backupCodes
          ) {
            var totalUsedCodes =
              BackupCodesManager.ExpectedNumberOfBackupCodes -
              backupCodes.length;
            if (totalUsedCodes > 0) {
              for (var i = 0; i < totalUsedCodes; i++) {
                backupCodes.unshift(
                  this._tfaProvider.plugin.getText('already_used')
                );
              }
            }
          ...
          BackupCodesManager.prototype.printBackupCodes = function (html) {
            ...
            printWindow.document.write(
              '<html><head><title>' +
                this._tfaProvider.plugin.getText('backup_codes') +
                '</title>'
            );
            printWindow.document.write(
              '<style>body{text-align:center;font-family:arial}table{border: 1px dashed;margin:0 auto}td{padding:15px;font-size:20px;}</style>'
            );
            printWindow.document.write('</head><body>');
            printWindow.document.write(
              '<h3>' +
                this._tfaProvider.plugin.getText(
                  'cant_access_use_backup_codes'
                ) +
                '</h3>'
            );
  ...
  \***************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function getElementByClassName(container, className) {
          return window.gigya.utils.DOM.getElementsByClass(
            container,
            className
          )[0];
        }
        exports.getElementByClassName = getElementByClassName;
        function createActionInterval(
          tfaProvider,
          action,
          interval,
          cancelCondition
          ...
          action(count).then(function () {
            return (canContinue = true);
          });
          var renderIntervalId = setInterval(function () {
            return tslib_1.__awaiter(_this, void 0, gigya.Promise, function () {
              return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    if (!(cancelCondition(count) || !tfaProvider.isActive()))
                      return [3 /*break*/, 1];
  ...
  \*******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function (
          ...
          Object.defineProperty(exports, '__esModule', { value: true });
          var Gigya_PluginsTfa = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/DefaultCss */ './src/accounts/Gigya.Js.Plugin.Tfa/app/DefaultCss.ts'
          );
          var Gigya_PluginsTfa_1 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/Templates */ './src/accounts/Gigya.Js.Plugin.Tfa/app/Templates.ts'
          );
          var Gigya_PluginsTfa_2 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaPlugin */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaPlugin.ts'
          );
          var Gigya_PluginsTfaFactory = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviderFactory */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviderFactory.ts'
          );
          var Gigya_PluginsTfaProviders = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/BaseTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/BaseTfaProvider.ts'
          );
          var Gigya_PluginsTfaProviders_1 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/EmailTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/EmailTfaProvider.ts'
          );
          var Gigya_PluginsTfaProviders_2 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/GigyaPhoneProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/GigyaPhoneProvider.ts'
          );
          var Gigya_PluginsTfaProviders_3 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/LiveLinkPhoneProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/LiveLinkPhoneProvider.ts'
          );
          var Gigya_PluginsTfaProviders_4 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/PhoneTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/PhoneTfaProvider.ts'
          );
          var Gigya_PluginsTfaProviders_5 = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/TotpTfaProvider */ './src/accounts/Gigya.Js.Plugin.Tfa/app/TfaProviders/TotpTfaProvider.ts'
          );
          if (!window.gigya._) {
            window.gigya._ = {};
          ...
          __webpack_provided_Object_dot_assign(
            window.gigya._.plugins.tfa.factory,
            Gigya_PluginsTfaFactory
          );
          __webpack_provided_Object_dot_assign(
            window.gigya._.plugins.tfa.providers,
            Gigya_PluginsTfaProviders,
            Gigya_PluginsTfaProviders_1,
            Gigya_PluginsTfaProviders_2,
            Gigya_PluginsTfaProviders_3,
            Gigya_PluginsTfaProviders_4,
            Gigya_PluginsTfaProviders_5
          );
          window.gigya._.UI.attachPlugin(
            Gigya_PluginsTfa_2.TfaPlugin,
            'accounts',
            'tfa',
            'showTfaUI'
          );
