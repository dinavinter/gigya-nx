/******/ (function (modules) {
  ...
  \****************************************************************************/
      ...
      /***/ function (module, exports) {
        ...
        (function () {
          if (typeof window.gigya.services.socialize.plugins == 'undefined')
            window.gigya.services.socialize.plugins = {};
          ...
          var privateScope = {
            ...
            getCacheKey: function (provider, url) {
              return (
                'getProviderShareCount_' +
                provider.toLowerCase() +
                '_' +
                encodeURIComponent(url)
              );
            },
            getProviderResponse: function (
              provider,
              url,
              callback,
              cacheTimeout
              ...
              window.gigya.utils.sessionCache.get(
                privateScope.getCacheKey(provider, url),
                cacheTimeout,
                function (response) {
                  if (response != null) {
            ...
            getProviderShareCount: function (provider, url, callback) {
              ...
              switch (provider) {
                ...
                case 'facebook':
                  ...
                  const facebookCountFields = countFields
                    .slice()
                    .reverse()
                ...
                case 'twitter':
                  ...
                  if (window.gigya.localInfo.protocol == 'https')
                    jsonpURL = jsonpURL.replace('http:', 'https:');
                ...
                case 'linkedin':
                  jsonpURL =
                    'https://www.linkedin.com/countserv/count/share?format=jsonp&url=' +
                    encodedURL +
                    '&callback=' +
                    callbackName;
                  countFieldPath = ['count'];
          ...
          _pi.shareCounts = {
            getProviderShareCounts: function (p) {
              ...
              var arProviders =
                window.gigya.services.socialize.getProvidersByName(
                  enabledProviders,
                  providers
                );
              arProviders = window.gigya.services.socialize.hideProvidersByName(
                arProviders,
                disabledProviders,
                providers
              );
              ...
              for (var i = 0; i < arProviders.length; i++) {
                ...
                if (!url) {
                  ...
                  for (var u = 0; u < metas.length; u++) {
                    if (
                      metas[u].getAttribute('property') == 'og:url' &&
                      metas[u].getAttribute('content')
                    ) {
                ...
                privateScope.getProviderResponse(
                  arProviders[i].name,
                  url,
                  fnOnResponse,
                  cacheTimeout
