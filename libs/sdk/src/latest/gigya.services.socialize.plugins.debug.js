/******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = './src/utils/Gigya.Js.Plugins.Debug/app/index.ts')
  );
  /******/
})(
  /************************************************************************/
  ...
  \**************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Templates_1 = __webpack_require__(
          /*! src/utils/Gigya.Js.Plugins.Debug/app/Templates */ './src/utils/Gigya.Js.Plugins.Debug/app/Templates.ts'
        );
        ...
        var DefaultCss_1 = __webpack_require__(
          /*! src/utils/Gigya.Js.Plugins.Debug/app/DefaultCss */ './src/utils/Gigya.Js.Plugins.Debug/app/DefaultCss.ts'
        );
        var FlagService_1 = __webpack_require__(
          /*! src/core/Gigya.Js/app/Services/FlagService */ './src/core/Gigya.Js/app/Services/FlagService.ts'
        );
        ...
        var DebugPlugin = /** @class */ (function () {
          function DebugPlugin(params, refString) {
            ...
            window.gigya.utils.script.load(
              window.gigya._.getCdnResource(
                '/webSDK/latest/External/jquery-1.11.1.min.js'
              ),
              null,
              function () {
          ...
          DebugPlugin.prototype.json2html = function (json, hidden, l) {
            ...
            var div = $('<div></div>');
            var divDataObject = $(
              '<div class="gig-debug-data-details-object"></div>'
            ).appendTo(div);
            var ul = $('<ul></ul>');
            if (hidden) {
            ...
            for (var i in json) {
              if (json.hasOwnProperty(i)) {
                ...
                var propNameElement = $(
                  '<span class="gig-debug-propertyName"></span>'
                );
                propNameElement.text(i + ':');
                var propValueElement = $(
                  '<span class="gig-debug-propertyValue"></span>'
                );
                if (typeof json[i] === 'object') {
                  if (json[i] == null) {
                    ...
                    var objectButton = $(
                      '<div class="gig-debug-data-details-openButton">{ }</div>'
                    );
          ...
          DebugPlugin.prototype.addLog = function (log) {
            log.data = window.gigya.utils.object.clone(
              log.data,
              false,
              false,
              6
          ...
          DebugPlugin.prototype.getLog = function (id) {
            for (var i = 0; i < this.history.length; i++) {
              if (this.history[i].id == id) return this.history[i];
            }
          };
          DebugPlugin.prototype.getLogEntryElement = function (log) {
            ...
            var $log = $('<div></div>')
              ...
              .html(
                '<span class="gig-debug-timestamp">[' +
            ...
            if (log.error) $log.addClass('gig-debug-history-entry-error');
            $log.find('[data-prop]').click(function (e) {
              return _this.onDataPropClick(e);
            });
            return $log;
          };
          DebugPlugin.prototype.onDataPropClick = function (e) {
            ...
            if (log.data[prop]) this.showDetails(log.data[prop], e.target);
          };
          DebugPlugin.prototype.showDetails = function (data, opener) {
            ...
            if (opener) $(opener).addClass('gig-debug-selected');
            var elDataContainer = $(
              '<div class="gig-debug-container gig-debug-data-details"></div>'
            );
            ...
            elData
              .find('.gig-debug-data-details-openButton')
              .click(function (e) {
                var btn = $(e.target);
          ...
          DebugPlugin.prototype.getInfo = function () {
            var oInfo = {
              ...
              'socialize.js': {
                ...
                'found script element':
                  window.gigya.thisScript.scriptElement != null,
              ...
              SSO: {
                ...
                'logout URL':
                  window.gigya.partnerSettings.ssoLogoutUrl || 'N/A',
              },
              browser: {
                'user agent': window.gigya.localInfo.userAgent,
                'window messaging method':
                  InternalFlows_1.MessagingMethod[
                    window.gigya.localInfo['messagingMethod']
                  ],
              },
              '3rd party integrations': {
                facebook: {
                  'app ID':
                    ...
                    'N/A',
                  'initialized time': window.gigya.external.facebook
                    .initializedTime
                    ? window.gigya.external.facebook.initializedTime.toLocaleTimeString()
                    : 'N/A',
          ...
          DebugPlugin.prototype.initUI = function () {
            ...
            this.$barContainer = this.$container.find(
              '.gig-debug-bar-container'
            );
            ...
            this.$historyButton = this.$container
              .find('.gig-debug-historyButton')
              .click(function () {
                _this.$history.slideToggle();
              });
            this.$detailsButton = this.$container
              .find('.gig-debug-detailsButton')
              .click(function () {
                if (_this.$details) _this.$details.slideToggle();
              });
            this.$saveCheckbox = this.$container
              .find('.gig-debug-autoload')
              .attr(
                'checked',
                window.gigya.utils.cookie.get(gigDebugCookieKey) == '1'
              )
              .change(function () {
                if (FlagService_1.FlagService.setCookieSameSiteLaxLowPriority) {
                  window.gigya.utils.cookie.set(
                    gigDebugCookieKey,
                    _this.shouldSaveAsString(),
                    null,
                    null,
                    null,
                    'Lax'
            ...
            this.$hideButton = this.$container
              .find('.gig-debug-hideButton')
              .click(function () {
                _this.$history.slideUp();
                if (_this.$details) _this.$details.slideUp();
          ...
          DebugPlugin.prototype.onFileSelected = function (files) {
            ...
            $(reader).load(function (event) {
              ...
              try {
                ...
                _this.addLog({
                  html:
                    '=== Import of <span data-prop="exception">' +
                    input.val() +
                    '</span> failed ===',
                  data: { exception: ex },
                  id: new Date().getTime() + '_' + Math.random(),
          ...
          DebugPlugin.prototype.clearAll = function () {
            this.clearHistory();
            this.$lastLogEntry.empty();
            if (this.$details) this.$details.slideUp();
            $('.gig-debug-selected').removeClass('gig-debug-selected');
          };
          DebugPlugin.prototype.exportJson = function () {
            var json = JSON.stringify(
              window.gigya.utils.object.clone(
                { history: this.history, info: this.getInfo() },
                true,
                false,
                4,
                null,
  ...
  \*******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function (
          ...
          Object.defineProperty(exports, '__esModule', { value: true });
          var Gigya_PluginsDebug = __webpack_require__(
            /*! src/utils/Gigya.Js.Plugins.Debug/app/DebugPlugin1 */ './src/utils/Gigya.Js.Plugins.Debug/app/DebugPlugin1.ts'
          );
          var Gigya_PluginsDebug_1 = __webpack_require__(
            /*! src/utils/Gigya.Js.Plugins.Debug/app/DefaultCss */ './src/utils/Gigya.Js.Plugins.Debug/app/DefaultCss.ts'
          );
          var Gigya_PluginsDebug_2 = __webpack_require__(
            /*! src/utils/Gigya.Js.Plugins.Debug/app/Templates */ './src/utils/Gigya.Js.Plugins.Debug/app/Templates.ts'
          );
          if (!window.gigya._) {
            window.gigya._ = {};
          ...
          __webpack_provided_Object_dot_assign(
            window.gigya._.plugins.debug,
            Gigya_PluginsDebug,
            Gigya_PluginsDebug_1,
            Gigya_PluginsDebug_2
          );
          window.gigya._.UI.attachPlugin(
            Gigya_PluginsDebug.DebugPlugin,
            'socialize',
            'debug',
            'showDebugUI'
          );
