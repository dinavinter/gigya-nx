/******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = './src/legacy/others/gigyaGAIntegration.js')
  );
  /******/
})(
  /************************************************************************/
      ...
      /***/ function (module, exports) {
        ...
        (function () {
          ...
          var _gaq_trackSocial = function () {
            _gaq.push(
              ['_trackSocial'].concat(Array.prototype.slice.call(arguments))
            );
          };
          var _gaq_trackEvent = function () {
            _gaq.push(
              ['_trackEvent'].concat(Array.prototype.slice.call(arguments))
            );
          };
          ...
          window.gigya.defaultEventMaps.push({
            ...
            eventMap: [
              ...
              },
              {
                ...
                method: _gaq_trackSocial,
                args: [
                  '$button.provider',
                  'Gigya Follow - button clicked',
                  '$button.actionURL',
                  document.location.href,
                ],
              },
              ...
              },
              {
                ...
                args: [
                  getCategoryFunction('Add Connection'),
              ...
              },
              {
                ...
                args: [
                  getCategoryFunction('Remove Connection'),
                  'Social Connection Removed',
                  '$provider',
                ],
              },
            ],
