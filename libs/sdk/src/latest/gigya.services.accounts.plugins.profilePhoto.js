...
***************************************************************************** */
  ...
  \*********************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        var result = __webpack_require__(
          /*! !../../../../../../node_modules/css-loader/dist/cjs.js!./style.css */ '../node_modules/css-loader/dist/cjs.js!./src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/css/style.css'
        );
  ...
  \***********************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.style = __webpack_require__(
          /*! ./css/style.css */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/css/style.css'
        );
  ...
  \************************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.display = __webpack_require__(
          /*! ./templates/display.html */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/templates/display.html'
        );
        exports.tooltipFileSize = __webpack_require__(
          /*! ./templates/tooltipFileSize.html */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/templates/tooltipFileSize.html'
        );
        exports.tooltipServerError = __webpack_require__(
          /*! ./templates/tooltipServerError.html */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/templates/tooltipServerError.html'
        );
        exports.upload = __webpack_require__(
          /*! ./templates/upload.html */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/templates/upload.html'
        );
  ...
  \****************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        /* WEBPACK VAR INJECTION */ (function (
          ...
          Object.defineProperty(exports, '__esModule', { value: true });
          var Gigya_PluginsProfilePhoto = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/profilePhoto */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/profilePhoto.ts'
          );
          exports.Gigya_PluginsProfilePhoto = Gigya_PluginsProfilePhoto;
          var cssResources = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/cssResources */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/cssResources.ts'
          );
          exports.cssResources = cssResources;
          var htmlResources = __webpack_require__(
            /*! src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/htmlResources */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/htmlResources.ts'
          );
          ...
          window.gigya._.UI.attachPlugin(
            Gigya_PluginsProfilePhoto.MyPhotoPlugin,
            'accounts',
            Gigya_PluginsProfilePhoto.MyPhotoPlugin.PLUGIN_NAME,
            'showMyPhotoUI'
          );
  ...
  \***********************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var image_1 = __webpack_require__(
          /*! ./image */ './src/accounts/Gigya.Js.Plugin.ProfilePhoto/app/image.ts'
        );
        var ServerStates;
        ...
        (function (ProfilePhotoModes) {
          ...
          (ProfilePhotoModes =
            exports.ProfilePhotoModes || (exports.ProfilePhotoModes = {}))
        );
        var ProfilePhotoUploadModes;
        (function (ProfilePhotoUploadModes) {
          ProfilePhotoUploadModes[(ProfilePhotoUploadModes['formSubmit'] = 0)] =
            'formSubmit';
          ProfilePhotoUploadModes[(ProfilePhotoUploadModes['serverApi'] = 1)] =
            'serverApi';
        })(
          (ProfilePhotoUploadModes =
            exports.ProfilePhotoUploadModes ||
            (exports.ProfilePhotoUploadModes = {}))
        );
        var ProfilePhotoErrorType;
        (function (ProfilePhotoErrorType) {
          ProfilePhotoErrorType[(ProfilePhotoErrorType['fileSizeError'] = 0)] =
            'fileSizeError';
          ProfilePhotoErrorType[(ProfilePhotoErrorType['serverError'] = 1)] =
            'serverError';
          ProfilePhotoErrorType[(ProfilePhotoErrorType['none'] = 2)] = 'none';
        })(
          (ProfilePhotoErrorType =
            exports.ProfilePhotoErrorType ||
            (exports.ProfilePhotoErrorType = {}))
        );
        var ProfilePhotoEditModes;
        (function (ProfilePhotoEditModes) {
          ProfilePhotoEditModes[(ProfilePhotoEditModes['upload'] = 0)] =
            'upload';
          ProfilePhotoEditModes[(ProfilePhotoEditModes['update'] = 1)] =
            'update';
          ProfilePhotoEditModes[(ProfilePhotoEditModes['remove'] = 2)] =
            'remove';
        })(
          (ProfilePhotoEditModes =
            exports.ProfilePhotoEditModes ||
            (exports.ProfilePhotoEditModes = {}))
        );
        ...
        var MyPhotoPlugin = /** @class */ (function (_super) {
          ...
          function MyPhotoPlugin() {
            ...
            _this.onUserStateChange = function (res) {
              return _this.userStateChanged(res);
            };
            ...
            _this._imageBase =
              window.gigya._.getCdnResource('/gs/i/profilePhoto');
            return _this;
          }
          ...
          MyPhotoPlugin.prototype.validateUserInputParams = function () {
            ...
            var isHeightNumber = !isNaN(
              parseFloat(this.params.height.toString())
            );
            if (!isWidthNumber) {
          ...
          MyPhotoPlugin.prototype.init = function (loadedCallback) {
            ...
            MyPhotoPlugin.UPDATE_PHOTO_TEXT = this.getText(
              'profilePhoto_update'
            );
            MyPhotoPlugin.UPLOAD_PHOTO_TEXT = this.getText(
              'profilePhoto_upload'
            );
            MyPhotoPlugin.FULL_DEFAULT_IMAGE_PATH =
              this._imageBase + '/photo_default.png';
            this.validateUserInputParams();
            // css -  injecting the css into the page.
            var css = window.gigya.utils.templates.fill(this.getCss().style, {
              scriptBase: this._imageBase,
            });
          ...
          MyPhotoPlugin.prototype.resetContainer = function () {
            ...
            this._pluginWrapperDiv = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gigya-myPhoto-profile-box-wrapper'
            )[0];
          ...
          MyPhotoPlugin.prototype.checkForProfilePhoto = function () {
            ...
            var accountInfoParams = {
              callback: this.prepareCallback(function (res) {
                return _this.onAccountInfoCheckCompleted(res);
              }),
          ...
          MyPhotoPlugin.prototype.onAccountInfoCheckCompleted = function (
            response
          ) {
          ...
          MyPhotoPlugin.prototype.getProfilePhotoURL = function () {
            ...
            return (
              this._currentPhotoURL || MyPhotoPlugin.FULL_DEFAULT_IMAGE_PATH
            );
          };
          MyPhotoPlugin.prototype.setProfilePhotoURL = function (response) {
            ...
            this._currentPhotoURL = newPhotoURL
              ? window.gigya.global.getPhotoURL(newPhotoURL)
              : null;
          };
          ...
          MyPhotoPlugin.prototype.onAccountInfoErrorWithRegToken = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
              return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                  case 0:
                    return [4 /*yield*/, this.getProfilePhotoUsingRegToken()];
                  case 1:
                    _a.sent();
                    return [2 /*return*/];
                }
          ...
          MyPhotoPlugin.prototype.setPhotoImage = function () {
            this._imageElement.style.background =
              "#FFF url('" + this.getProfilePhotoURL() + "') 50% 50% no-repeat";
            var isPhotoWider = this.arePhotoDimensionsWider(
              this._photoDimensions
            );
            if (isPhotoWider) {
          ...
          MyPhotoPlugin.prototype.render = function () {
            ...
            this._imageElement = this.container.querySelector(
              '#' + this.containerID + ' .' + MyPhotoPlugin.IMAGE_CLASS
            );
            this.setPhotoImage();
          ...
          MyPhotoPlugin.prototype.getDOMElements = function (uploadId) {
            ...
            this._formWrapper = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gigya-myPhoto-form-wrapper'
            )[0];
            this._infoTooltipElement = document.querySelector(
              '#' + this.containerID + ' .gigya-myPhoto-tooltip-wrap'
            );
            this._iconElement = document.querySelector(
              '#' + this.containerID + ' .gigya-myPhoto-status-icon'
            );
            this._tooltipContainer = window.gigya.utils.DOM.getElementsByClass(
              this.container,
              'gigya-myPhoto-tooltip'
            )[0];
            this._tooltipTextContainer =
              window.gigya.utils.DOM.getElementsByClass(
                this.container,
                'gigya-myPhoto-tooltip-text-wrap'
              )[0];
            this._uploadForm = document.querySelector(
              '#' + this.containerID + ' form'
            );
            this._isFilesFeatureSupported =
              window.gigya.localInfo.isBrowserSupportsFilesAPI;
            this._uploadTextElement = document.querySelector(
              '#' + this.containerID + ' .gigya-myPhoto-upload-button'
            );
            this._removePhotoButton = document.querySelector(
              '#' + this.containerID + ' .gigya-myPhoto-delete-button'
            );
            (_a = this._removePhotoButton) === null || _a === void 0
              ? void 0
              : _a.setAttribute('tabindex', '0');
            (_b = this._removePhotoButton) === null || _b === void 0
              ? void 0
              : _b.setAttribute('role', 'button');
            (_c = this._removePhotoButton) === null || _c === void 0
              ? void 0
              : _c.setAttribute('aria-label', 'remove photo');
            (_d = this._removePhotoButton) === null || _d === void 0
              ? void 0
              : _d.addEventListener('keydown', function (event) {
                  ...
                  if (
                    ...
                    (_a = _this._removePhotoButton) === null || _a === void 0
                      ? void 0
                      : _a.click();
                  }
                });
            this._uploadIframeID =
              this.params.containerID + '_upload' + uploadId + '_target';
            this._formID =
              this.params.containerID + '_upload' + uploadId + '_form';
          };
          MyPhotoPlugin.prototype.setDOMEvents = function () {
            var _this = this;
            this._removePhotoButtonClicked = function () {
              return _this.onRemovePhotoButtonClicked();
            };
            this._fileInputClicked = function () {
              return _this.onFileInputClicked();
            };
            this._fileInputChanged = function () {
              return _this.onFileInputChange();
            };
            this._iconMouseHover = function () {
              return _this.onIconHovered();
            };
          };
          MyPhotoPlugin.prototype.registerLocalEvents = function () {
            ...
            this.listenOnIframe = function () {
              var iframeStateName = _this._uploadIframe.getAttribute(
                exports.IframeUploadInfo.uploading
              );
            ...
            window.gigya.utils.DOM.addEventListener(
              this._fileInput,
              'change',
              this._fileInputChanged
            );
            window.gigya.utils.DOM.addEventListener(
              this._fileInput,
              'click',
              this._fileInputClicked
            );
            window.gigya.utils.DOM.addEventListener(
              this._iconElement,
              'mouseover',
              this._iconMouseHover
            );
            (_a = this._dummyBtn) === null || _a === void 0
              ? void 0
              : _a.addEventListener('keydown', function (event) {
                  ...
                  if (
                    ...
                    (_a = _this._fileInput) === null || _a === void 0
                      ? void 0
                      : _a.click();
                  }
                });
          };
          MyPhotoPlugin.prototype.setRemovePhotoButton = function (
            allowRemove
          ) {
            if (allowRemove) {
              ...
              window.gigya.utils.DOM.addEventListener(
                ...
                'click',
                this._removePhotoButtonClicked
              );
            } else {
          ...
          MyPhotoPlugin.prototype.updateUserPhoto = function (res) {
            this._editMode = ProfilePhotoEditModes.update;
            var isNewUpdatedPhotoWider = this.arePhotoDimensionsWider(
              res.dimensions
            );
          ...
          MyPhotoPlugin.prototype.registerToGlobalEvents = function () {
            ...
            this.addGlobalEventHandler(
              MyPhotoPlugin.USER_INFO_CHANGE_EVENT,
                ...
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    params = tslib_1.__assign(
                      tslib_1.__assign({}, generalRequestParams),
                      accountInfoParams
                    );
              ...
              return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                    ...
                    if (
                      !(
                        this._fileInput.files[0].size >
                        MyPhotoPlugin.MAX_IMAGE_BYTE_SIZE
                      )
                    )
                      return [3 /*break*/, 1];
                    this._fileInput.value = null;
                    this._currentErrorType =
                      ProfilePhotoErrorType.fileSizeError;
                    this._currnetErrorText = this._fileSizeErrorText;
                  ...
                  case 1:
                    ...
                    return [
                      4 /*yield*/,
                      image_1.getImageBase64(
                        this._fileInput.files[0],
                        this.params.fixImageOrientation
                      ),
                    ];
                  case 2:
          ...
          MyPhotoPlugin.prototype.startServerQuery = function () {
            ...
            this._uploadIframe.setAttribute(
              exports.IframeUploadInfo.uploading,
              ServerStates[this._photoProfileState]
            );
            if (!this.uploadCheckInterval)
              this.uploadCheckInterval = window.setInterval(
                this.listenOnIframe,
                exports.IframeUploadInfo.uploadCheckInterval
              );
            return this._lastQueryId;
          };
          MyPhotoPlugin.prototype.onServerQueryEnd = function (
            serverQueryId,
            newState,
            data
          ) {
              ...
              return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    return [3 /*break*/, 4];
                  case 2:
                    return [4 /*yield*/, this.sendPhotoWithServerApi()];
                  case 3:
                    _a.sent();
                    _a.label = 4;
                  case 4:
                ...
                switch (_d.label) {
                  case 0:
                    ...
                    this._lastResponseId =
                      this._uploadIframeID + '_' + this._lastQueryId;
                    _a =
                      'https://' +
                      window.gigya._.getApiDomain('accounts') +
                      '/accounts.uploadProfilePhoto?publish=true&context=' +
                      this._lastResponseId +
                      '&saveResponseID=' +
                      this._lastResponseId +
                      '&';
          ...
          MyPhotoPlugin.prototype.getServerParameters = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
              ...
              return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                  case 0:
                    params = window.gigya.utils.object.extractProperties(
                      this.params,
                      {},
                      'APIKey|cid|oauth_token|login_token|source|sourceData|regToken'
                    );
                    params.authMode = params['oauth_token']
                      ? 'token'
                      : 'cookie';
                    if (!params.APIKey)
                    ...
                    params.login_token = webAdapter.tokenStore.get(
                      params.APIKey
                    );
                    _a = params;
                    return [
                ...
                switch (_c.label) {
                  ...
                  case 1:
                    ...
                    window.gigya._.apiAdapter.sendRequest(
                      'socialize.getSavedResponse',
                      params,
                      function (res) {
                        return _this.onUploadSavedResponse(res);
                      },
                      {
            ...
            switch (res.errorCode) {
              case GSErrors_1.GSErrors.OK:
                ...
                window.gigya.accounts.getAccountInfo({
                  callback: this.onUpdatedPhotoCompleted,
                  context: this,
                  include: 'profile,data',
                });
                break;
          ...
          MyPhotoPlugin.prototype.onUpdatedPhotoCompleted = function (
            response
          ) {
            var _a, _b;
            var self = response.context;
            if (
              ((_a = response.profile) === null || _a === void 0
                ? void 0
                : _a.thumbnailURL) ||
              ((_b = response.profile) === null || _b === void 0
                ? void 0
                : _b.photoURL)
            ) {
          ...
          MyPhotoPlugin.prototype.resetPhotoContainer = function () {
            ...
            window.gigya.utils.DOM.addClassToElement(
              this.innerContainer,
              MyPhotoPlugin.CLASSES_STATES.upload
            );
            window.gigya.utils.DOM.removeClassFromElement(
              this.innerContainer,
              MyPhotoPlugin.CLASSES_STATES.update
            );
            this.render();
          };
          MyPhotoPlugin.prototype.onPhotoDimensionsRetreived = function () {
            if (this._pluginInitialized) {
              ...
              this.toggleErrorIndication(false);
              this._uploadTextElement.innerHTML =
                MyPhotoPlugin.UPDATE_PHOTO_TEXT;
              window.gigya.events.global.dispatch(
                {
                  isInternal: false,
                  eventName: MyPhotoPlugin.EVENT_TYPES.onUserInfoChanged,
                },
                {
                  sourceData: {
                    photoURL: this.getProfilePhotoURL(),
                    dimensions: this._photoDimensions,
                  },
                }
              );
              ...
              return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    getProfilePhotoParams.type = window.gigya.localInfo.isIE8
                      ? 'thumbnail'
                      : 'orig';
                    // ts = time stamp for 'cache buster'
                    getProfilePhotoParams.ts = new Date().getTime();
                    url = this.buildUrlForProfilePhotoAPI(
                    ...
                    img.onerror = function () {
                      if (!self._pluginInitialized) {
                        self._currentPhotoURL =
                          self._imageBase + '/photo_default.png';
                        ...
                        self._isPhotoUploaded = false;
                        self._currentErrorType =
                          ProfilePhotoErrorType.serverError;
                        self._currnetErrorText = self.getServerErrorText(
                        ...
                        if (self._editMode === ProfilePhotoEditModes.upload) {
                          ...
                          window.gigya.pluginUtils.DOM.showElement(
                            self._iconElement
                          );
                        } else {
                          window.gigya.utils.DOM.addClassToElement(
          ...
          MyPhotoPlugin.prototype.buildUrlForProfilePhotoAPI = function (
            getProfilePhotoParams
          ) {
            return (
              (getProfilePhotoParams.login_token ||
              getProfilePhotoParams.regToken
                ? 'https'
                : window.gigya.localInfo.protocol) +
              '://' +
              window.gigya._.getApiDomain('accounts') +
              '/accounts.getProfilePhoto?' +
          ...
          MyPhotoPlugin.prototype.getImageDimensions = function (callback) {
            ...
            img.onerror = function () {
              ...
              window.gigya.pluginUtils.DOM.showElement(
                _this._uploadTextElement
              );
              callback(_this);
            };
            img.src = this.getProfilePhotoURL();
          };
          MyPhotoPlugin.prototype.arePhotoDimensionsWider = function (
            dimenstions
          ) {
            return (
              dimenstions.width > parseInt(this.params.width) ||
              dimenstions.height > parseInt(this.params.height)
            );
          };
          ...
          MyPhotoPlugin.prototype.getControlHtml = function () {
            ...
            if (this._pluginMode == ProfilePhotoModes.upload) {
              ...
              var editClass =
                this._editMode == ProfilePhotoEditModes.upload
                  ? 'gigya-myPhoto-status-upload'
                  : 'gigya-myPhoto-status-uploaded';
              template = window.gigya.utils.templates.fill(
                this.getTemplates().upload,
                {
          ...
          MyPhotoPlugin.prototype.createIFrameElement = function () {
            ...
            this._uploadIframe.setAttribute(
              exports.IframeUploadInfo.uploading,
              ServerStates[ServerStates.NotStarted]
            );
            this._uploadIframe.setAttribute(
              'onload',
              "this.setAttribute('" +
                exports.IframeUploadInfo.uploading +
                "','" +
                ServerStates[ServerStates.Done] +
                "')"
            );
          ...
          MyPhotoPlugin.prototype.showLoader = function (el) {
            ...
            window.gigya.utils.DOM.addClassToElement(
              el,
              MyPhotoPlugin.CLASSES_STATES.loading
            );
          ...
          MyPhotoPlugin.prototype.toggleErrorIndication = function (showError) {
            if (showError) {
              ...
              window.gigya.utils.DOM.addClassToElement(
                this.innerContainer,
                MyPhotoPlugin.CLASSES_STATES.error
              );
          ...
          MyPhotoPlugin.SERVER_ERROR_TEXT =
            'An error has occurred while trying to upload photo';
  ...
  \******************************************************************************/
      ...
      /***/ function (module, exports) {
        module.exports =
          '<div class="gigya-myPhoto-profile-box-wrapper">\n    <div class="gigya-myPhoto-profile-image"></div>\n</div>\n';
