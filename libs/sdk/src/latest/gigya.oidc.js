/******/ (function (modules) {
  ...
  /******/ return __webpack_require__(
    (__webpack_require__.s = './src/fidm/Gigya.Js.OidcProxy/app/index.ts')
  );
  /******/
})(
  /************************************************************************/
...
***************************************************************************** */
  ...
  \**********************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var url_1 = __webpack_require__(
          /*! ./url */ './src/fidm/Fidm.Common/utils/url.ts'
        );
        ...
        function findConfiguration() {
          ...
          if (!configObj) throw new Error('No object params was found.');
          ...
          return (_d =
            (_c =
              (_b =
                ...
                ? void 0
                : _b.flags) === null || _c === void 0
              ? void 0
              : _c.redirectOnMissingOidcContext) !== null && _d !== void 0
            ? _d
            : false;
        }
            ...
            (_d =
              (_c =
                (_b =
                  ...
                  : _b.flags) === null || _c === void 0
                ? void 0
                : _c.oidcUseLocalStorage) !== null && _d !== void 0
              ? _d
              : false;
        ...
        function calcHostname(configObj) {
          ...
          if (
            configObj.hostname &&
            configObj.hostname.match(
              /(?:-st\d+)\.(gigya-api\.cn|sapcdm\.cn|gigya\.com)/
            )
          ) {
        ...
        function loadGigyaJS(apiKey, originHostname) {
          ...
          var src =
            'https://' + originHostname + '/js/gigya.js?apiKey=' + apiKey;
        ...
        function waitForGigyaServiceReady(done) {
          ...
          window['onGigyaServiceReady'] = function () {
            if (prevHandler) prevHandler.apply(this, arguments);
            done();
          };
        }
  ...
  \***********************************************/
      ...
      /***/ function (module, exports) {
        ...
        function getUid(callback, ignoreInterruptions) {
          if (ignoreInterruptions === void 0) {
            ignoreInterruptions = false;
          }
  ...
  \***********************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        Object.defineProperty(exports, '__esModule', { value: true });
        var script_1 = __webpack_require__(
          /*! ./script */ './src/fidm/Fidm.Common/utils/script.ts'
        );
        ...
        function saveContext(apiKey, context, done) {
          ...
          var savedContexts =
            cache.get(key, sessionStorageTimeout) ||
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function getParams(_win) {
          ...
          var result = urlParams(
            _win.location().hash || _win.location().search
          );
  ...
  \*********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var storage_1 = __webpack_require__(
          /*! ../../Fidm.Common/utils/storage */ './src/fidm/Fidm.Common/utils/storage.ts'
        );
        var oidcAPIs_1 = __webpack_require__(
          /*! ./oidcAPIs */ './src/fidm/Gigya.Js.OidcProxy/app/oidcAPIs.ts'
        );
        var script_1 = __webpack_require__(
          /*! ../../Fidm.Common/utils/script */ './src/fidm/Fidm.Common/utils/script.ts'
        );
        function processAfterConsent(params, configuration) {
          storage_1.loadContext(configuration.apiKey, function (savedParams) {
            if (
              script_1.redirectOnMissingOidcContext() &&
              !(savedParams === null || savedParams === void 0
                ? void 0
                : savedParams.context)
            ) {
  ...
  \*******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var session_1 = __webpack_require__(
          /*! ../../Fidm.Common/utils/session */ './src/fidm/Fidm.Common/utils/session.ts'
        );
        var oidcAPIs_1 = __webpack_require__(
          /*! ./oidcAPIs */ './src/fidm/Gigya.Js.OidcProxy/app/oidcAPIs.ts'
        );
          ...
          storage_1.loadContext(configuration.apiKey, function (savedParams) {
            ...
            if (
              ...
              window.gigya.logger.report(
                'oidc call continue when there is no context',
                {},
                false,
                FlagService_1.FlagService.forceErrorReport
              );
            }
            storage_1.saveContext(
              configuration.apiKey,
              savedParams,
              function () {
                session_1.getUid(function (uidParams) {
                  if (
                    session_1.activeUserExists(
                      configuration.apiKey,
                      uidParams.UID
                    )
                  ) {
                    oidcAPIs_1.redirectAfterLogin(
                      configuration,
                      uidParams,
                      savedParams
                    );
  ...
  \******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var oidcProxy_1 = __webpack_require__(
          /*! ./oidcProxy */ './src/fidm/Gigya.Js.OidcProxy/app/oidcProxy.ts'
        );
        function bootstrap() {
          var configObj = script_1.findConfiguration();
          script_1.ensureJsSdkLoaded(
            configObj.apiKey,
            configObj.originHostname,
            function () {
              return oidcProxy_1.processRequest(configObj);
            }
          );
        }
  ...
  \*******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function processForceLogin(params, configuration) {
          if (!params['context']) throw new Error('missing context param');
  ...
  \**************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var bootstrap_1 = __webpack_require__(
          /*! ./bootstrap */ './src/fidm/Gigya.Js.OidcProxy/app/bootstrap.ts'
        );
        exports.bootstrap = bootstrap_1.bootstrap;
        bootstrap_1.bootstrap();
        var forceLogin = __webpack_require__(
          /*! ./forceLogin */ './src/fidm/Gigya.Js.OidcProxy/app/forceLogin.ts'
        );
        exports.forceLogin = forceLogin;
        var login = __webpack_require__(
          /*! ./login */ './src/fidm/Gigya.Js.OidcProxy/app/login.ts'
        );
        exports.login = login;
        var passiveLogin = __webpack_require__(
          /*! ./passiveLogin */ './src/fidm/Gigya.Js.OidcProxy/app/passiveLogin.ts'
        );
        exports.passiveLogin = passiveLogin;
        var afterLogin = __webpack_require__(
          /*! ./afterLogin */ './src/fidm/Gigya.Js.OidcProxy/app/afterLogin.ts'
        );
        exports.afterLogin = afterLogin;
        var afterConsent = __webpack_require__(
          /*! ./afterConsent */ './src/fidm/Gigya.Js.OidcProxy/app/afterConsent.ts'
        );
        ...
        var url = __webpack_require__(
          /*! ../../Fidm.Common/utils/url */ './src/fidm/Fidm.Common/utils/url.ts'
        );
        exports.url = url;
  ...
  \**************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function processLogin(params, configuration) {
          var _a;
          if (!params['context']) {
            (_a = window.gigya._.apiAdapters.web.apiService) === null ||
            _a === void 0
              ? void 0
              : _a.sendReport('missing oidc context', {
              ...
              if (
                session_1.activeUserExists(
                  configuration === null || configuration === void 0
                    ? void 0
                    : configuration.apiKey,
                  uidParams === null || uidParams === void 0
                    ? void 0
                    : uidParams.UID
                )
              ) {
  ...
  \*****************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function redirectToLogin(configObject) {
          var _a, _b;
          var scriptConf = window.gigya.utils.JSON.deserialize(
            configObject.configJson
          );
          if (!scriptConf) throw new Error('The params object is not valid.');
          url_1.redirect(scriptConf.loginURL, {
            gig_ui_locales:
              (_a = url_1.getParameterByName('gig_ui_locales')) !== null &&
              _a !== void 0
                ? _a
                : null,
            gig_login_hint:
              (_b = url_1.getParameterByName('gig_login_hint')) !== null &&
              _b !== void 0
                ? _b
                : null,
          });
            ...
            return tslib_1.__generator(this, function (_d) {
              switch (_d.label) {
                ...
                case 1:
                  _a.apply(
                    void 0,
                    _b.concat([((_c.gmidTicket = _d.sent()), _c), apiKey])
                  );
                  return [2 /*return*/];
              }
            });
        ...
        function redirectToContinueEndPoint(endPoint, params, apiKey) {
          ...
          url_1.redirect(
            'https://' +
              window.gigya._.getApiDomain('fidm') +
              '/oidc/op/v1.0/' +
              apiKey +
              '/' +
              endPoint,
  ...
  \******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var forceLogin_1 = __webpack_require__(
          /*! ./forceLogin */ './src/fidm/Gigya.Js.OidcProxy/app/forceLogin.ts'
        );
        var passiveLogin_1 = __webpack_require__(
          /*! ./passiveLogin */ './src/fidm/Gigya.Js.OidcProxy/app/passiveLogin.ts'
        );
        var afterLogin_1 = __webpack_require__(
          /*! ./afterLogin */ './src/fidm/Gigya.Js.OidcProxy/app/afterLogin.ts'
        );
        var afterConsent_1 = __webpack_require__(
          /*! ./afterConsent */ './src/fidm/Gigya.Js.OidcProxy/app/afterConsent.ts'
        );
        var oidcAPIs_1 = __webpack_require__(
          /*! ./oidcAPIs */ './src/fidm/Gigya.Js.OidcProxy/app/oidcAPIs.ts'
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function processPassiveLogin(params, configuration) {
          ...
          storage_1.saveContext(configuration.apiKey, params, function () {
            session_1.getUid(function (uidParams) {
              if (
                session_1.activeUserExists(configuration.apiKey, uidParams.UID)
              ) {
                oidcAPIs_1.redirectAfterLogin(configuration, uidParams, params);
              } else {
