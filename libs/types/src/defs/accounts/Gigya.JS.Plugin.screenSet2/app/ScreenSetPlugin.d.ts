...
import { ScreenSetData } from 'src/accounts/Gigya.JS.Plugin.screenSet2/app/ScreenSetData';
...
import { BaseForm, IFormData } from 'src/accounts/Gigya.JS.Plugin.screenSet2/app/BaseForm';
import { IErrorInfo } from 'src/accounts/Gigya.JS.Plugin.screenSet2/app/Errors';
import { ITemplateElementParent } from 'src/accounts/Gigya.JS.Plugin.screenSet2/app/TemplateElement';
import { IElementActualSize, IElementSize, IViewportSize } from 'src/core/Gigya.Js/app/Interfaces';
import { ScreenOptions } from 'src/accounts/Gigya.JS.Plugin.screenSet2/app/ScreenOptions';
...
import { TranslationsContainer } from "../../../core/Gigya.Js.Plugin/app/Utils/languages/language";
